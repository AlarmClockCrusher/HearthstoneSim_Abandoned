...
class Layer1Window:
	def __init__(self):
		self.window = tk.Tk()
		self.btn_Start = tk.Button(self.window, text=txt("Loading. Please wait", CHN), bg="red", font=("Yahei", 15, "bold"), command=self.init_ShowBase)
		...
		hero1_Opt.config(width=15, font=("Yahei", 15))
		hero1_Opt["menu"].config(font=("Yahei", 15))
		#self.hero1Label = tk.Label(self.window, text="Hero 1:Demon Hunter", font=("Yahei", 15))
		#self.hero1Label.pack()
		#hero1_Var.trace("w", lambda *arg: self.hero1Label.configure(text="Hero 1 :" + hero1_Var.get()))
		...
		hero2_Opt.config(width=15, font=("Yahei", 15))
		hero2_Opt["menu"].config(font=("Yahei", 15))
		#self.hero1Label = tk.Label(self.window, text="Hero 2:Demon Hunter", font=("Yahei", 15))
		#self.hero1Label.pack()
		#hero2_Var.trace("w", lambda *arg: self.hero1Label.configure(text="Hero 1 :" + hero2_Var.get()))
		
		self.deck1 = tk.Entry(self.window, font=("Yahei", 12), width=30)
		self.deck2 = tk.Entry(self.window, font=("Yahei", 12), width=30)
