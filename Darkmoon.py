...
class CarnivalClown(Minion):
	...
	index = "Darkmoon~Neutral~Minion~9~4~4~None~Carnival Clown~Taunt~Battlecry~ToCorrupt"
...
class ArmorVendor(Minion):
	...
	mana, attack, health = 1, 1, 3
	index = "Darkmoon~Neutral~Minion~1~1~3~None~Armor Vendor~Battlecry"
...
class Deathwarden(Minion):
	...
	mana, attack, health = 3, 2, 5
	index = "Darkmoon~Neutral~Minion~3~2~5~None~Deathwarden"
...
class FelfireDeadeye(Minion):
	...
	mana, attack, health = 2, 2, 3
	index = "Darkmoon~Demon Hunter,Hunter~Minion~2~2~3~None~Felfire Deadeye"
...
class Saddlemaster(Minion):
	...
	mana, attack, health = 3, 3, 4
	index = "Darkmoon~Hunter~Minion~3~3~4~None~Saddlemaster"
...
class GlacierRacer(Minion):
	...
	mana, attack, health = 1, 1, 3
	index = "Darkmoon~Mage~Minion~1~1~3~None~Glacier Racer"
...
class KeywardenIvory(Minion):
	...
	mana, attack, health = 5, 4, 5
	index = "Darkmoon~Mage,Rogue~Minion~5~4~5~None~Keywarden Ivory~Battlecry~Legendary"
...
class ImprisonedCelestial(Minion_Dormantfor2turns):
	...
	mana, attack, health = 3, 4, 5
	index = "Darkmoon~Paladin~Minion~3~4~5~None~Imprisoned Celestial"
...
class DarkInquisitorXanesh(Minion):
	...
	mana, attack, health = 5, 3, 5
	index = "Darkmoon~Priest~Minion~5~3~5~None~Dark Inquisitor Xanesh~Battlecry~Legendary"
	requireTarget, keyWord, description = False, "", "Your healing effects also give affected minions +2 Health"
	name_CN = "黑暗审判官 夏奈什"
...
class SparkjoyCheat(Minion_Dormantfor2turns):
	...
	mana, attack, health = 3, 3, 3
	index = "Darkmoon~Rogue~Minion~3~3~3~None~Sparkjoy Cheat~Battlecry"
...
class Mistrunner(Minion):
	...
	mana, attack, health = 5, 4, 4
	index = "Darkmoon~Shaman~Minion~5~4~4~None~Mistrunner~Battlecry~Overload"
...
class LuckysoulHoarder(Minion):
	...
	mana, attack, health = 3, 3, 4
	index = "Darkmoon~Warlock,Demon Hunter~Minion~3~3~4~None~Luckysoul Hoarder~Battlecry~ToCorrupt"
...
class LuckysoulHoarder_Corrupt(Minion):
	Class, race, name = "Warlock,Demon Hunter", "", "Luckysoul Hoarder"
	mana, attack, health = 3, 3, 4
	index = "Darkmoon~Warlock,Demon Hunter~Minion~3~3~4~None~Luckysoul Hoarder~Battlecry~Corrupted~Uncollectible"
...
class RaceGuard(Minion):
	...
	mana, attack, health = 3, 2, 4
	index = "Darkmoon~Warrior,Paladin~Minion~3~2~4~None~Race Guard~Taunt~Uncollectible"
	requireTarget, keyWord, description = False, "Taunt", "Taunt"
	name_CN = "赛道护卫"
