...
ClassesandNeutral = ["Neutral", "Demon Hunter", "Druid", "Hunter", "Mage", "Monk", "Paladin", "Priest", "Rogue", "Shaman", "Warlock", "Warrior"]
...
class ZephrystheGreat(Minion):
	...
	def generatePool(cls, Game):
		...
		basicandClassicClassCards = {"Neutral": [], "Demon Hunter": [], "Druid": [], "Mage": [], "Hunter": [], "Monk": [], "Paladin": [], "Priest": [],
