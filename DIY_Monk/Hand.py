...
#Resuscitate, ArchoftheTemple, CanewithaWineGourd, MonksApprentice, ShaohaosProtection, EffusiveMists, PurifyingBrew, SwiftBrewmaster, Provoke, SweepingKickFighter, 
...
Experiment1 = [Resuscitate, ShaohaosProtection, EffusiveMists, SwiftBrewmaster, Provoke, SweepingKickFighter, TouchofKarma, IronbeakOwl, IronbeakOwl,
				Liquor, Transcendance, TouchofKarma, SpiritTether, DrunkenBoxing, SpawnofXuen, ShaohaotheEmperor, ShaohaotheEmperor, RushingJadeWind, KunLaiSummitZenAlchemist, FistsoftheHeavens, FistsoftheHeavens, FistsoftheHeavens, 
				]

Experiment2 = [Evocation, Evocation, SorcerersApprentice, SorcerersApprentice, SorcerersApprentice, SorcerersApprentice, Tracking, Tracking,
