...
class MasterSleuth(SVMinion):
    ...
    index = "SV_Eternal~Neutral~Minion~2~2~2~~Master Sleuth~Battlecry~Enhance"
    requireTarget, effects, description = False, "", "Fanfare: Enhance (5) - Evolve this follower."
...
class VyrnLilRedDragon(SVMinion):
    ...
    index = "SV_Eternal~Neutral~Minion~2~1~1~~Vyrn, Li'l Red Dragon~Battlecry~Enhance"
    requireTarget, effects, description = False, "", "Fanfare: Draw a card.Enhance (6): Evolve this follower instead. Recover 4 play points."
    attackAdd, healthAdd = 2, 2
    name_CN = "小小的红龙·碧"
...
class AngelicMelody(SVSpell):
    Class, school, name = "Neutral", "", "Angelic Melody"
...
class IoJourneymage(SVMinion):
    ...
    index = "SV_Eternal~Neutral~Minion~2~1~2~~Io, Journeymage~Battlecry~Enhance"
    requireTarget, effects, description = True, "", "Fanfare: Deal 1 damage to an enemy follower and then 1 damage to the enemy leader. Restore 1 defense to your leader.Enhance (5): Deal 2 damage, restore 2 defense, and gain +2/+2 instead.Enhance (8): Deal 4 damage, restore 4 defense, and gain +4/+4 instead."
    attackAdd, healthAdd = 2, 2
    name_CN = "苍心的少女·伊欧"
...
class ArchangelofRemembrance(SVMinion):
    ...
    index = "SV_Eternal~Neutral~Minion~2~2~1~~Archangel of Remembrance~Battlecry"
    requireTarget, effects, description = True, "", "Fanfare: Banish an enemy follower with 1 defense."
    attackAdd, healthAdd = 2, 2
...
class FluffyAngel(SVMinion):
    ...
    index = "SV_Eternal~Neutral~Minion~3~2~3~~Fluffy Angel~Battlecry~Deathrattle"
    requireTarget, effects, description = False, "Taunt", "Ward.Fanfare and Last Words: Restore 2 defense to your leader."
    attackAdd, healthAdd = 2, 2
    name_CN = "飘柔天使"
...
class EugenStalwartSkyfarer(SVMinion):
    ...
    index = "SV_Eternal~Neutral~Minion~3~2~3~~Eugen, Stalwart Skyfarer"
    requireTarget, effects, description = False, "", "Clash: Give +1/+0 to all allied followers.Can evolve for 0 evolution points."
    attackAdd, healthAdd = 2, 2
    name_CN = "苍烈的志士·欧根"
...
class GransResolve(SVSpell):
    Class, school, name = "Neutral", "", "Gran's Resolve"
...
class DjeetasDetermination(SVSpell):
    Class, school, name = "Neutral", "", "Djeeta's Determination"
	requireTarget, mana, effects = False, 0, ""
...
class GranDjeetaEternalHeroes(SVMinion):
    ...
    index = "SV_Eternal~Neutral~Minion~5~5~5~~Gran & Djeeta, Eternal Heroes~Charge~Legendary~Uncollectible"
    requireTarget, effects, description = False, "Charge", "Storm.Strike: The next time this follower takes damage, reduce that damage to 0. Rally (20): Gain the following effect - Can attack 2 times per turn. Rally (40): Evolve this follower.Can't be evolved using evolution points. (Can be evolved using card effects.)"
...
class Trig_GranDjeetaEternalHeroes(TrigBoard):
    ...
    def effect(self, signal, ID, subject, target, number, comment, choice=0):
        self.entity.effects["Next Damage 0"] = 1
...
class OnWingsofTomorrow(SVSpell):
    Class, school, name = "Neutral", "", "On Wings of Tomorrow"
...
class BahamutPrimevalDragon_Accelerate(SVSpell):
    Class, school, name = "Neutral", "", "Bahamut, Primeval Dragon"
	requireTarget, mana, effects = False, 5, ""
...
class WalderForestRanger(SVMinion):
    ...
    index = "SV_Eternal~Forestcraft~Minion~1~1~1~~Walder, Forest Ranger~Charge~Battlecry~Enhance~Invocation"
    requireTarget, effects, description = False, "Charge", "Invocation: When you play a card using its Accelerate effect for the second time this turn, invoke this card.Storm.Fanfare: Enhance (6) - Gain +X/+X. X equals the number of times you've played a card using its Accelerate effect this match."
    attackAdd, healthAdd = 2, 2
    name_CN = "森之战士·维鲁达"
...
class ElfSorcerer(SVMinion):
    ...
    mana, attack, health = 2, 2, 2
    index = "SV_Eternal~Forestcraft~Minion~2~2~2~~Elf Sorcerer~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: Put a Fairy into your hand."
    attackAdd, healthAdd = 2, 2
    name_CN = "精灵咒术师"
    ...
    def inHandEvolving(self, target=None):
        for card in self.Game.Hand_Deck.hands[self.ID]:
            if type(card) == Fairy:
                card.getsEffect("Bane")


class MimlemelFreewheelingLass(SVMinion):
    Class, race, name = "Forestcraft", "", "Mimlemel, Freewheeling Lass"
    mana, attack, health = 2, 2, 2
    index = "SV_Eternal~Forestcraft~Minion~2~2~2~~Mimlemel, Freewheeling Lass~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: If at least 2 other cards were played this turn, summon a Stumpeye."
    attackAdd, healthAdd = 2, 2
...
class Stumpeye(SVMinion):
    ...
    index = "SV_Eternal~Forestcraft~Minion~4~4~1~~Stumpeye~Rush~Uncollectible"
    requireTarget, effects, description = False, "Rush", "Rush. Strike: Give +0/+1 to all allied Mimlemel, Freewheeling Lasses."
    attackAdd, healthAdd = 2, 2
    name_CN = "残株"
...
class BlossomTreant(SVMinion):
    ...
    index = "SV_Eternal~Forestcraft~Minion~4~1~6~~Blossom Treant~Deathrattle"
    requireTarget, effects, description = False, "", "At the start of your turn, evolve this follower.Last Words: Draw a card."
...
class Astoreth(SVMinion):
    ...
    index = "SV_Eternal~Forestcraft~Minion~4~4~4~~Astoreth~Taunt~Battlecry"
    requireTarget, effects, description = False, "Taunt", "Ward.Fanfare: If at least 2 other cards were played this turn, evolve this follower."
    attackAdd, healthAdd = 2, 2
    name_CN = "阿斯塔蒂"
...
class TweyenDarkHuntress(SVMinion):
    ...
    index = "SV_Eternal~Forestcraft~Minion~4~3~3~~Tweyen, Dark Huntress~Bane~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary"
    requireTarget, effects, description = True, "Bane", "Bane.Fanfare: Select an enemy follower. It can't attack until the end of your opponent's turn.Skybound Art (10): Evolve this follower. Give +2/+0 to all other allied followers.Super Skybound Art (15): Strike - Deal X damage to all enemies. X equals this follower's attack."
    attackAdd, healthAdd = 2, 2
    name_CN = "魔眼的猎人·索恩"
...
class GreenwoodReindeer(SVMinion):
    ...
    mana, attack, health = 5, 5, 5
    index = "SV_Eternal~Forestcraft~Minion~5~5~5~~Greenwood Reindeer~Rush~Battlecry"
    requireTarget, effects, description = False, "Rush", "Rush.Fanfare: If at least 2 other cards were played this turn, gain +0/+5."
    attackAdd, healthAdd = 2, 2
    name_CN = "深绿驯鹿"
...
class XenoSagittarius_Crystallize(Amulet):
    ...
    mana = 1
    index = "SV_Eternal~Forestcraft~Amulet~1~~Xeno Sagittarius~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible"
...
class XenoSagittarius(SVMinion):
    ...
    index = "SV_Eternal~Forestcraft~Minion~6~6~4~~Xeno Sagittarius~Battlecry~Crystallize~Legendary"
    requireTarget, effects, description = False, "", "Crystallize (1): Countdown (1)When this amulet is returned to your hand, draw a card.Last Words: Draw a card.Fanfare: Change the defense of all enemy followers to 1.Strike: Deal 1 damage to all enemy followers.When this follower is returned to your hand, deal 1 damage to all enemy followers."
...
class NatureConsumed(SVSpell):
    Class, school, name = "Forestcraft", "", "Nature Consumed"
...
class PrimordialColossus(SVMinion):
    ...
    index = "SV_Eternal~Forestcraft~Minion~7~4~6~~Primordial Colossus~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: Give your leader the following effect - Once on each of your turns, when you play a card, recover 2 play points and add 2 to the number of cards played this turn. (This effect is not stackable and lasts for the rest of the match.)"
    attackAdd, healthAdd = 2, 2
    name_CN = "原始的恶神"
...
class Trig_PrimordialColossus(TrigBoard):
    def __init__(self, entity):
        super().__init__(entity, ["MinionPlayed", "SpellPlayed", "WeaponPlayed", "HeroCardPlayed", "AmuletPlayed"])
...
class WindFairy_Accelerate(SVSpell):
    Class, school, name = "Forestcraft", "", "Wind Fairy"
...
class WindFairy(SVMinion):
    ...
    index = "SV_Eternal~Forestcraft~Minion~9~3~3~~Wind Fairy~Charge~Windfury~Accelerate"
    requireTarget, effects, description = True, "Charge,Windfury", "Fanfare: Give your leader the following effect - Once on each of your turns, when you play a card, recover 2 play points and add 2 to the number of cards played this turn. (This effect is not stackable and lasts for the rest of the match.)"
...
class ArthurSlumberingDragon(SVMinion):
    ...
    requireTarget, effects, description = False, "", "At the end of your turn, Rally (10): Give your leader the following effect - The next time your leader takes damage, reduce that damage to 0."
    attackAdd, healthAdd = 2, 2
    name_CN = "沉睡的辉龙·亚瑟"
...
class Trig_ArthurSlumberingDragon(TrigBoard):
    ...
    def effect(self, signal, ID, subject, target, number, comment, choice=0):
        if self.entity.Game.Counters.numMinionsSummonedThisGame[self.entity.ID] >= 10:
            self.entity.Game.heroes[self.entity.ID].effects["Next Damage 0"] = 1
...
class MordredSlumberingLion(SVMinion):
    ...
    requireTarget, effects, description = False, "", "At the end of your turn, Rally (5): Deal 1 damage to all enemy followers."
    attackAdd, healthAdd = 2, 2
    name_CN = "沉睡的狮子·莫德雷德"
...
class ProvenMethodology(SVSpell):
    Class, school, name = "Swordcraft", "", "Proven Methodology"
	requireTarget, mana, effects = False, 2, ""
...
class MirinSamuraiDreamer(SVMinion):
    ...
    requireTarget, effects, description = False, "", "Fanfare: Skybound Art (10) - Deal 3 damage to the enemy leader. Super Skybound Art (15): Deal 6 damage instead."
    attackAdd, healthAdd = 2, 2
    name_CN = "武士梦想家·米琳"
...
class SwordSwingingBandit(SVMinion):
    ...
    requireTarget, effects, description = False, "Charge", "Storm.Last Words: Summon a Bullet Bike."
    attackAdd, healthAdd = 2, 2
    name_CN = "残刃蛮贼"
...
class GrandAuction(SVSpell):
    Class, school, name = "Swordcraft", "", "Grand Auction"
	requireTarget, mana, effects = True, 1, ""
...
class AgewornWeaponry(Amulet):
    ...
    mana = 2
    index = "SV_Eternal~Swordcraft~Amulet~2~~Ageworn Weaponry~Countdown~Deathrattle~Uncollectible"
...
class Greatshield(Amulet):
    ...
    mana = 2
    index = "SV_Eternal~Swordcraft~Amulet~2~~Greatshield~Countdown~Battlecry~Deathrattle~Uncollectible"
...
class Greatsword(Amulet):
    ...
    mana = 2
    index = "SV_Eternal~Swordcraft~Amulet~2~~Greatsword~Countdown~Battlecry~Deathrattle~Uncollectible"
...
class StoneMerchant(SVMinion):
    ...
    requireTarget, effects, description = False, "", "Fanfare: Put 2 Grand Auctions into your hand."
    attackAdd, healthAdd = 2, 2
    name_CN = "奇石商贩"
...
class SeofonStarSwordSovereign(SVMinion):
    ...
    requireTarget, effects, description = False, "", "Fanfare: Put a random card with Enhance or Super Skybound Art from your deck into your hand.Skybound Art (10): Evolve all unevolved allied Swordcraft followers. Evolve effects will not activate for them.Super Skybound Art (15): Gain the following effects.-Reduce damage to this follower to 0.-Can't be destroyed by effects."
    attackAdd, healthAdd = 2, 2
    name_CN = "天星剑王·希耶提"
    ...
    def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
        ...
        if sa:
            for minion in self.Game.minionsonBoard(self.ID):
                if minion.Class == "Swordcraft" and minion.effects["Evolved"] < 1:
                    minion.evolve()
        if ssa:
...
class VictoriousGrappler(SVMinion):
    ...
    requireTarget, effects, description = False, "", "Fanfare: Give all allied Officer followers the following effect - Clash: Deal 2 damage to the enemy leader.Clash: Deal 2 damage to the enemy leader."
    attackAdd, healthAdd = 2, 2
    name_CN = "武斗女兵"
...
class AverageAxeman(SVMinion):
    ...
    requireTarget, effects, description = False, "Charge,Bane", "Storm.Bane.Strike: Recover X play points. X equals this follower's attack."
    attackAdd, healthAdd = 2, 2
    name_CN = "锐斧战士"
...
class RampagingRhino(SVMinion):
    ...
    requireTarget, effects, description = False, "Rush", "Rush.Fanfare: Destroy a random enemy follower or amulet."
    attackAdd, healthAdd = 2, 2
    name_CN = "蛮冲铁犀"
...
class AlistairTinyMagus(SVMinion):
    ...
    index = "SV_Eternal~Runecraft~Minion~1~0~1~~Alistair, Tiny Magus~Battlecry~Deathrattle"
    requireTarget, effects, description = True, "", "Fanfare: Deal X damage to an enemy follower. X equals the last digit of your leader's defense.Last Words: Spellboost the cards in your hand."
    attackAdd, healthAdd = 2, 2
    name_CN = "小小的术士·阿里斯特拉"
...
class ImpalementArts(SVSpell):
    Class, school, name = "Runecraft", "", "Impalement Arts"
	requireTarget, mana, effects = True, 1, ""
...
class ElmottPyrestarter(SVMinion):
    ...
    mana, attack, health = 2, 3, 1
    index = "SV_Eternal~Runecraft~Minion~2~3~1~~Elmott, Pyrestarter~Battlecry~Spellboost"
    requireTarget, effects, description = True, "", "Fanfare: Deal X damage to an enemy follower. X equals the number of times this card has been Spellboosted. Then, if X is at least 10, deal 4 damage to the enemy leader."
    attackAdd, healthAdd = 2, 2
    name_CN = "炎狱的葬送者·艾尔莫特"
...
class ElixirMixer(SVSpell):
    Class, school, name = "Runecraft", "", "Elixir Mixer"
    ...
    def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
        if target:
            ...
            target.getsEffect("Bane")
            target.getsEffect("Drain")


class ForceBarrier(SVSpell):
    Class, school, name = "Runecraft", "", "Force Barrier"
	requireTarget, mana, effects = False, 2, ""
...
class Trig_ForceBarrier(TrigBoard):
    def __init__(self, entity):
        super().__init__(entity, ["AbilityDmgHero", "AbilityDmgMinion", "TurnEnds"])
...
class AcademicArchmage(SVMinion):
    ...
    mana, attack, health = 3, 2, 3
    index = "SV_Eternal~Runecraft~Minion~3~2~3~~Academic Archmage~Battlecry"
    requireTarget, effects, description = True, "", "Fanfare: Deal 1 damage to an enemy follower and then 1 damage to the enemy leader. If you have 20 cards or less in your deck, deal 3 damage instead."
    attackAdd, healthAdd = 2, 2
    name_CN = "博学的魔导士"
        ...
        if sa:
            ...
            if curGame.mode == 0:
                if curGame.picks:
                    ...
                    curGame.picks_Backup.append(minions)
...
class CrystalWitch(SVMinion):
    ...
    index = "SV_Eternal~Runecraft~Minion~5~2~3~~Crystal Witch~Battlecry~Spellboost"
    requireTarget, effects, description = False, "", "Spellboost: Subtract 1 from the cost of this card.Fanfare: Draw a card. Spellboost the cards in your hand."
    attackAdd, healthAdd = 2, 2
    name_CN = "石英魔女"
...
class XenoIfrit_Crystallize(Amulet):
    ...
    mana = 3
    index = "SV_Eternal~Runecraft~Amulet~3~~Xeno Ifrit~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible"
...
class PholiaRetiredSovereign(SVMinion):
    ...
    index = "SV_Eternal~Runecraft~Minion~7~4~4~~Pholia, Retired Sovereign~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: The next time this follower takes damage, reduce that damage to 0. Summon a Bai Ze."
    attackAdd, healthAdd = 2, 2
    ...
    def inHandEvolving(self, target=None):
        for minion in self.Game.minionsonBoard():
            if type(minion) == BaiZe and minion.effects["Evolved"] == 0:
                minion.evolve()
...
class BaiZe(SVMinion):
    ...
    mana, attack, health = 7, 4, 6
    index = "SV_Eternal~Runecraft~Minion~7~4~6~~Bai Ze~Rush~Taunt~Uncollectible"
    requireTarget, effects, description = False, "Rush,Taunt", "Rush.Ward.At the end of your turn, give all allied Pholia, Retired Sovereigns the following effect: The next time this follower takes damage, reduce that damage to 0."
    attackAdd, healthAdd = 2, 2
    name_CN = "白泽"
    ...
    def effect(self, signal, ID, subject, target, number, comment, choice=0):
        for minion in self.entity.Game.minionsonBoard():
            if type(minion) == PholiaRetiredSovereign:
                minion.effects["Next Damage 0"] = 1
...
class RagingGolem(SVMinion):
    ...
    index = "SV_Eternal~Runecraft~Minion~8~6~6~~Raging Golem~Rush~Crystallize~Deathrattle"
    requireTarget, effects, description = False, "Rush", "Crystallize (2): Earth SigilLast Words: Summon a Guardian Golem.Rush.Last Words: Summon 2 Guardian Golems."
...
class DragonRearing(SVSpell):
    Class, school, name = "Dragoncraft", "", "Dragon Rearing"
	requireTarget, mana, effects = True, 1, ""
...
class SharkWarrior(SVMinion):
    ...
    mana, attack, health = 2, 2, 2
    index = "SV_Eternal~Dragoncraft~Minion~2~2~2~~Shark Warrior~Battlecry~Enhance"
    requireTarget, effects, description = True, "", "Fanfare: Discard a card. Restore 4 defense to your leader.Enhance (5): Gain +2/+2. Draw a card."
    attackAdd, healthAdd = 2, 2
    name_CN = "鲨鱼战士"
...
class MermaidArcher(SVMinion):
    ...
    index = "SV_Eternal~Dragoncraft~Minion~2~0~5~~Mermaid Archer~Battlecry~Enhance"
    requireTarget, effects, description = False, "", "Once each turn, when this follower takes damage, if it's not destroyed, deal 2 damage to a random enemy follower."
    attackAdd, healthAdd = 2, 2
    name_CN = "人鱼弓手"
...
class HypersonicDragonewt(SVMinion):
    ...
    index = "SV_Eternal~Dragoncraft~Minion~4~3~2~~Hypersonic Dragonewt~Charge~Battlecry"
    requireTarget, effects, description = False, "Charge", "Storm. Fanfare: If Overflow is active for you, gain Last Words - Summon a Hypersonic Dragonewt."
    attackAdd, healthAdd = 2, 2
    name_CN = "残影龙人"
...
class GiantBasilisk(SVMinion):
    Class, race, name = "Dragoncraft", "", "Hypersonic Dragonewt"
    mana, attack, health = 4, 4, 4
    index = "SV_Eternal~Dragoncraft~Minion~4~4~4~~Hypersonic Dragonewt~Bane~Battlecry"
    requireTarget, effects, description = False, "Bane", "Bane. Fanfare: If you discarded any cards this turn, evolve this card."
    attackAdd, healthAdd = 2, 2
    name_CN = "巨型巴西利斯克"
...
class RaziaVengefulCannonlancer(SVMinion):
    ...
    index = "SV_Eternal~Dragoncraft~Minion~4~2~4~~Razia, Vengeful Cannonlancer~Taunt~Deathrattle"
    requireTarget, effects, description = False, "Taunt", "Ward.Clash: Gain +1/+0.Last Words: Deal X damage to the enemy leader. X equals this follower's attack."
    attackAdd, healthAdd = 2, 2
...
class ThreoDivineHavoc(SVMinion):
    ...
    def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
        ...
        if ssa:
            self.effects["Can Attack 3 times"] = 1
...
class TempestDragon(SVMinion):
    ...
    mana, attack, health = 5, 5, 5
    index = "SV_Eternal~Dragoncraft~Minion~5~5~5~~Tempest Dragon"
    requireTarget, effects, description = False, "", "At the end of your turn, put a random Dragoncraft follower that originally costs 2, 4, 6, 8, or 10 play points from your deck into your hand."
    attackAdd, healthAdd = 2, 2
    name_CN = "风霆之龙"
...
class LadivaChampionofLove(SVMinion):
    ...
    index = "SV_Eternal~Dragoncraft~Minion~6~4~6~~Ladiva, Champion of Love~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: If any enemy followers are in play, lose 1 play point orb and evolve this follower.Clash: Give -2/-0 to the enemy follower."
    attackAdd, healthAdd = 2, 2
    name_CN = "爱之大殿堂·法斯蒂瓦"
...
class GhandagozaFistofRage(SVMinion):
    ...
    index = "SV_Eternal~Dragoncraft~Minion~9~8~7~~Ghandagoza, Fist of Rage~Rush"
    requireTarget, effects, description = False, "Rush", "Rush.Strike: Deal X damage to the enemy leader. X equals this follower's attack."
    attackAdd, healthAdd = 2, 2
...
class DisrestanOceanHarbinger_Accelerate(SVSpell):
    Class, school, name = "Dragoncraft", "", "Disrestan, Ocean Harbinger"
...
class ShaoShadyApothecary(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~1~1~2~~Shao, Shady Apothecary~Battlecry~Necromancy"
    requireTarget, effects, description = False, "", "Fanfare: Necromancy (6) - Reanimate (4)."
    attackAdd, healthAdd = 2, 2
    name_CN = "妖艳的药剂师·萧"


class UndeadParade(SVSpell):
    Class, school, name = "Shadowcraft", "", "Undead Parade"
	requireTarget, mana, effects = True, 1, ""
...
class WingedZombie(SVMinion):
    ...
    mana, attack, health = 2, 2, 2
    index = "SV_Eternal~Shadowcraft~Minion~2~2~2~~Winged Zombie"
    requireTarget, effects, description = False, "", "When you perform Necromancy, gain Storm."
    attackAdd, healthAdd = 2, 2
    name_CN = "骨翼傀儡"
...
class PsychopompTourGuide(SVMinion):
    ...
    mana, attack, health = 2, 2, 1
    index = "SV_Eternal~Shadowcraft~Minion~2~2~1~~Psychopomp Tour Guide~Battlecry"
    requireTarget, effects, description = True, "", "Fanfare: If any other allied followers are in play, destroy 1 and draw 2 cards."
    attackAdd, healthAdd = 2, 2
    name_CN = "灵魂向导"
...
class NiyonMysticMusician(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~2~1~4~~Niyon, Mystic Musician~Stealth~Taunt~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary"
    requireTarget, effects, description = False, "Stealth,Taunt", "Ambush.Ward.Fanfare: Skybound Art (10) - Give +1/+1 and Bane to all allied followers.Super Skybound Art (15): Remove Ward from all enemy followers, and give them the following effect until the end of your opponent's turn - Can't attack."
    attackAdd, healthAdd = 2, 2
    name_CN = "细致入微的魔奏者·妮欧"
    ...
    def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
        ...
        if sa:
            for minion in self.Game.minionsonBoard(self.ID):
                ...
                minion.getsEffect("Bane")
        if ssa:
            for minion in self.Game.minionsonBoard(3 - self.ID):
                minion.losesEffect("Taunt")
...
class Skullfish(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~3~3~2~~Skullfish~Rush~Deathrattle"
    requireTarget, effects, description = False, "Rush", "Rush. Last Words: Necromancy (2) - Deal 2 damage to the enemy leader."
    attackAdd, healthAdd = 2, 2
    name_CN = "骸骨鱼"
...
class TriHeadHound(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~3~1~1~~Tri-Head Hound~Deathrattle"
    requireTarget, effects, description = False, "", "Last Words: Summon a 5-play point, 2-attack Tri-Head Hound with the following effect - Last Words: Summon a 7-play point, 3-attack Tri-Head Hound without Last Words."
    attackAdd, healthAdd = 2, 2
    name_CN = "三头犬"
...
class TriHeadHound_Token(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~5~2~1~~Tri-Head Hound~Deathrattle~Uncollectible"
    requireTarget, effects, description = False, "", "Last Words: Summon a 7-play point, 3-attack Tri-Head Hound without Last Words."
    attackAdd, healthAdd = 2, 2
    name_CN = "三头犬"
...
class TriHeadHound_Token2(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~7~3~1~~Tri-Head Hound~Uncollectible"
...
class ZajaDeliriousBerserker(SVMinion):
    ...
    mana, attack, health = 4, 3, 4
    index = "SV_Eternal~Shadowcraft~Minion~4~3~4~~Zaja, Delirious Berserker~Taunt~Battlecry"
    requireTarget, effects, description = True, "Taunt", "Ward.Fanfare: Burial Rite - Gain the ability to evolve for 0 evolution points."
    attackAdd, healthAdd = 2, 2
    name_CN = "打破虚妄的战士·扎扎"
...
class LonesomeNecromancer(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~6~4~5~~Lonesome Necromancer~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: Summon a Ghost. Reanimate (4)."
    attackAdd, healthAdd = 2, 2
    name_CN = "友善的唤灵师"
...
class VaseragaShadowedScythe(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~7~4~7~~Vaseraga, Shadowed Scythe~Deathrattle"
    requireTarget, effects, description = False, "", "Can't be targeted by enemy effects.Last Words: Summon a Vaseraga, Shadowed Scythe."
    attackAdd, healthAdd = 2, 2
    name_CN = "幽冥钢刃·巴萨拉卡"
...
class RuinbladeReaper(SVMinion):
    ...
    index = "SV_Eternal~Shadowcraft~Minion~10~1~7~~Ruinblade Reaper~Bane~Necromancy~Legendary"
    requireTarget, effects, description = False, "Bane", "At the end of your turn, if you have 5 cards in play and at least 15 shadows, change the cost of this card to 0.Bane.When this card comes into play, perform Necromancy (20): Evolve this follower.Can't be evolved using evolution points. (Can be evolved using card effects.)"
...
class RougeVampire(SVMinion):
    ...
    mana, attack, health = 1, 1, 1
    index = "SV_Eternal~Bloodcraft~Minion~1~1~1~~Rouge Vampire~Drain~Battlecry"
    requireTarget, effects, description = False, "Drain", "Drain.Fanfare: If Wrath is not active for you, deal 1 damage to your leader. Otherwise, gain +2/+2 and Rush."
    attackAdd, healthAdd = 2, 2
    name_CN = "殷红暗夜眷属"
...
class WickedWolf(SVMinion):
    ...
    mana, attack, health = 2, 2, 2
    index = "SV_Eternal~Bloodcraft~Minion~2~2~2~~Wicked Wolf~Bane~Battlecry~Enhance"
    requireTarget, effects, description = False, "Bane", "Bane.Fanfare: Enhance (7) - Summon 3 Wicked Wolves. Give all allied Wicked Wolves the following effect: Reduce damage from effects to 0."
    attackAdd, healthAdd = 2, 2
    name_CN = "邪恶魔狼"
...
class SkullFreedomRaider(SVMinion):
    ...
    mana, attack, health = 2, 2, 1
    index = "SV_Eternal~Bloodcraft~Minion~2~2~1~~Skull, Freedom Raider~Rush~Battlecry"
    requireTarget, effects, description = False, "Rush", "Rush.Fanfare: If Vengeance is active for you, gain Storm.Fanfare: If Avarice is active for you, gain +2/+2."
    attackAdd, healthAdd = 2, 2
...
class HallessenaCalamitysSaw(SVMinion):
    ...
    mana, attack, health = 3, 2, 1
    index = "SV_Eternal~Bloodcraft~Minion~3~2~1~~Hallessena, Calamity's Saw~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: The next time this follower takes damage, reduce that damage to 0.Strike: Gain +1/+0.Can't be attacked."
    attackAdd, healthAdd = 2, 2
    name_CN = "坏天灾·哈雷泽娜"


class CorruptingBloodlust(SVSpell):
    Class, school, name = "Bloodcraft", "", "Corrupting Bloodlust"
...
class DiscerningDevil(SVMinion):
    ...
    mana, attack, health = 4, 3, 3
    index = "SV_Eternal~Bloodcraft~Minion~4~3~3~~Discerning Devil~Battlecry~Deathrattle"
    requireTarget, effects, description = False, "", "Fanfare: Draw a card.Last Words: At the start of your next turn, draw a card."
    attackAdd, healthAdd = 2, 2
    name_CN = "洞察的恶魔"
...
class GluttonousDemon(SVMinion):
    ...
    index = "SV_Eternal~Bloodcraft~Minion~4~2~8~~Gluttonous Demon"
    requireTarget, effects, description = False, "", "Can't attack.Once on each of your turns, when this follower's attack or defense is increased by an effect, destroy a random enemy follower and restore 3 defense to your leader.At the end of your turn, if Avarice is active for you, gain +2/+0."
...
class KnightofPurgatory(SVMinion):
    ...
    mana, attack, health = 4, 4, 4
    index = "SV_Eternal~Bloodcraft~Minion~4~4~4~~Knight of Purgatory~Taunt~Battlecry~Invocation"
    requireTarget, effects, description = False, "Taunt", "Invocation: At the end of your turn, if Wrath is active for you, invoke this card. Then, banish all Knights of Purgatory from your deck.Ward.Fanfare: Restore 4 defense to your leader."
    attackAdd, healthAdd = 2, 2
    name_CN = "炼狱之黑暗骑士"
...
class DemonicBerserker(SVMinion):
    ...
    mana, attack, health = 5, 5, 5
    index = "SV_Eternal~Bloodcraft~Minion~5~5~5~~Demonic Berserker~Rush~Battlecry"
    requireTarget, effects, description = False, "Rush", "Rush.Fanfare: Deal 1 damage to a random leader. Do this 3 times."
    attackAdd, healthAdd = 2, 2
    name_CN = "恶魔狂战士"
...
class SeoxHeavenlyHowl(SVMinion):
    ...
    index = "SV_Eternal~Bloodcraft~Minion~6~4~2~~Seox, Heavenly Howl~Rush~Windfury~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary"
    requireTarget, effects, description = False, "Rush,Windfury", "Rush.Fanfare: Skybound Art (10) - Subtract 5 from the cost of all Swordcraft followers in your hand.Super Skybound Art (15): Subtract 5 from the cost of all Swordcraft followers in your deck.During your turn, when this follower attacks and destroys an enemy follower, if this follower is not destroyed, evolve it."
    attackAdd, healthAdd = 2, 2
    name_CN = "神狼·希斯"
...
class XenoDiablo_Crystallize(Amulet):
    ...
    mana = 3
    index = "SV_Eternal~Bloodcraft~Amulet~3~~Xeno Diablo~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible"
...
class Trig_SummitTemple(TrigBoard):
    def __init__(self, entity):
        super().__init__(entity, ["MinionAttacksHero", "MinionAttacksMinion"])
...
class Trig_AttUsesHealth(TrigBoard):
    def __init__(self, entity):
        super().__init__(entity, ["BattleDmgHero", "BattleDmgMinion", "TurnEnds"])
...
class WillUnderworldPriest(SVMinion):
    ...
    mana, attack, health = 1, 1, 2
    index = "SV_Eternal~Havencraft~Minion~1~1~2~~Will, Underworld Priest~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: Restore 1 defense to all allies. If Avarice is active for you, deal 1 damage to the enemy leader."
    attackAdd, healthAdd = 2, 2
...
class UnicornAltar(Amulet):
    ...
    mana = 1
    index = "SV_Eternal~Havencraft~Amulet~1~~Unicorn Altar~Countdown~Deathrattle"
...
class Unicorn(SVMinion):
    ...
    index = "SV_Eternal~Havencraft~Minion~6~5~5~~Unicorn~Battlecry~Uncollectible"
    requireTarget, effects, description = True, "", "Fanfare: Restore 3 defense to an ally."
    attackAdd, healthAdd = 2, 2
    name_CN = "独角兽"
...
class BelfrySister(SVMinion):
    ...
    mana, attack, health = 2, 2, 2
    index = "SV_Eternal~Havencraft~Minion~2~2~2~~Belfry Sister~Battlecry~Enhance"
    requireTarget, effects, description = False, "", "Fanfare: Enhance (5) - Gain the ability to evolve for 0 evolution points."
    attackAdd, healthAdd = 2, 2
    name_CN = "钟楼的修女"
...
class AnretheEnlightenedOne(SVMinion):
    ...
    mana, attack, health = 2, 1, 1
    index = "SV_Eternal~Havencraft~Minion~2~1~1~~Anre, the Enlightened One~Taunt~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary"
    requireTarget, effects, description = True, "Taunt", "Bane.Fanfare: Select an enemy follower. It can't attack until the end of your opponent's turn.Skybound Art (10): Evolve this follower. Give +2/+0 to all other allied followers.Super Skybound Art (15): Strike - Deal X damage to all enemies. X equals this follower's attack."
    attackAdd, healthAdd = 2, 2
    name_CN = "开眼者·乌诺"
...
class ZahlhamelinaSunPriestess(SVMinion):
    ...
    index = "SV_Eternal~Havencraft~Minion~3~1~5~~Zahlhamelina, Sun Priestess~Taunt"
    requireTarget, effects, description = False, "Taunt", "Ward.If this follower has 2 defense or less, whenever an allied follower attacks, deal 2 damage to the enemy leader."
    attackAdd, healthAdd = 2, 2
    name_CN = "日轮的巫女·扎哈梅丽娜"


class RedeemersCudgel(SVSpell):
    Class, school, name = "Havencraft", "", "Redeemer's Cudgel"
...
class SwordAlmiraj(SVMinion):
    ...
    index = "SV_Eternal~Havencraft~Minion~5~3~6~~Sword Al-mi'raj~Rush"
    requireTarget, effects, description = False, "Rush", "Rush.At the end of your turn, restore 2 defense to your leader."
    attackAdd, healthAdd = 2, 2
    name_CN = "跃剑月兔妖"
...
class XenoVohuManah_Crystallize(Amulet):
    ...
    mana = 3
    index = "SV_Eternal~Havencraft~Amulet~3~~Xeno Vohu Manah~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible"
...
class SacredTiger_Crystallize(Amulet):
    ...
    mana = 3
    index = "SV_Eternal~Havencraft~Amulet~3~~Sacred Tiger~Countdown~Crystallize~Deathrattle~Uncollectible"
...
class SacredTiger(SVMinion):
    ...
    index = "SV_Eternal~Havencraft~Minion~7~3~3~~Sacred Tiger~Charge~Crystallize"
    requireTarget, effects, description = False, "Charge", "Crystallize (3): Countdown (2)Last Words: Summon a White Tiger and Holyflame Tiger.Storm.Fanfare: Summon a White Tiger and Holyflame Tiger."
...
class WhiteTiger(SVMinion):
    ...
    mana, attack, health = 3, 3, 2
    index = "SV_Eternal~Havencraft~Minion~3~3~2~~White Tiger~Taunt~Uncollectible"
    requireTarget, effects, description = False, "Taunt", "Ward. Can't be targeted by enemy effects."
    attackAdd, healthAdd = 2, 2
    name_CN = "圣洁之虎"
...
class NoaPrimalShipwright_Crystallize(Amulet):
    ...
    mana = 1
    index = "SV_Eternal~Havencraft~Amulet~1~~Noa, Primal Shipwright~Countdown~Crystallize~Deathrattle~Uncollectible"
...
class NoaPrimalShipwright(SVMinion):
    ...
    index = "SV_Eternal~Havencraft~Minion~7~1~1~~Noa, Primal Shipwright~Taunt~Crystallize"
    requireTarget, effects, description = True, "", "Crystallize (1): Countdown (4)Last Words: Summon a Noa, Primal Shipwright.Fanfare: Remove all effects on an enemy follower except changes to its attack or defense. Then, give it -0/-5. (Followers are destroyed when their defense drops below 1.)When this follower comes into play, gain +X/+X. X equals your Rally count (excluding this card). If X is at least 10, evolve this follower."
...
class MechanizedSoldier(SVMinion):
    ...
    mana, attack, health = 2, 2, 2
    index = "SV_Eternal~Portalcraft~Minion~2~2~2~~Mechanized Soldier~Battlecry~Enhance"
    requireTarget, effects, description = False, "", "Fanfare: Enhance (4) - Summon a Mechanized Soldier.Enhance (6): Summon 2 instead.Enhance (8): Summon 3 instead, and give all allied Mechanized Soldiers the ability to evolve for 0 evolution points."
    attackAdd, healthAdd = 2, 2
    name_CN = "机械化步兵"
...
class CatherineNightsmoke(SVMinion):
    ...
    mana, attack, health = 2, 2, 1
    index = "SV_Eternal~Portalcraft~Minion~2~2~1~~Catherine, Nightsmoke~Stealth~Battlecry"
    requireTarget, effects, description = False, "Stealth", "Ambush.Fanfare: Choose - Put 1 of the following cards into your hand.-Gilded Goblet-Gilded Boots-Gilded Necklace"
    attackAdd, healthAdd = 2, 2
    name_CN = "夜失的桃烟·凯瑟琳"
...
class SpinnahSpinArtist(SVMinion):
    ...
    mana, attack, health = 2, 1, 3
    index = "SV_Eternal~Portalcraft~Minion~2~1~3~~Spinnah, Spin Artist~Battlecry~Enhance"
    requireTarget, effects, description = False, "", "Fanfare: Enhance (4) - Evolve this follower.Strike: If Resonance is active for you, gain the ability to attack 2 times this turn."
    attackAdd, healthAdd = 2, 2
    name_CN = "回转艺术家·斯平纳"
...
class LunaluFangirlA(SVMinion):
    ...
    mana, attack, health = 2, 2, 2
    index = "SV_Eternal~Portalcraft~Minion~2~2~2~~Lunalu, Fangirl A"
    requireTarget, effects, description = False, "", ""
    attackAdd, healthAdd = 2, 2
    name_CN = "妄想少女A·露娜露"
...
class Facsimile(SVSpell):
    Class, school, name = "Portalcraft", "", "Facsimile"
	requireTarget, mana, effects = False, 1, ""
...
class FeowerDoubleBladeFlash(SVMinion):
    ...
    index = "SV_Eternal~Portalcraft~Minion~2~4~2~~Feower, Double Blade Flash~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary"
    requireTarget, effects, description = False, "", "Fanfare: Until the end of your opponent's turn, give -4/-0 to a random enemy follower with the highest attack in play.Skybound Art (10): Deal 4 damage to a random enemy follower. Do this 3 times.Super Skybound Art (15): Give all allied followers the ability to attack 2 times per turn.At the end of turns you are unable to evolve, return this card to your hand."
    attackAdd, healthAdd = 2, 2
    name_CN = "闪耀的双剑·卡托尔"
    ...
    def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
        ...
        if ssa:
            for minion in self.Game.minionsonBoard(self.ID):
                minion.getsEffect("Windfury")


class TienTreacherousTrigger(SVMinion):
    Class, race, name = "Portalcraft", "", "Tien, Treacherous Trigger"
    mana, attack, health = 3, 2, 4
    index = "SV_Eternal~Portalcraft~Minion~3~2~4~~Tien, Treacherous Trigger~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary"
    requireTarget, effects, description = False, "", "Fanfare: Draw a card.Skybound Art (10): Gain +2/+0 and Storm.Super Skybound Art (15): Give Storm to all followers in your hand.At the end of turns you are unable to evolve, return this card to your hand."
    attackAdd, healthAdd = 2, 2
    name_CN = "魔弹的射手·艾瑟尔"
...
class SurveillanceSystem(SVMinion):
    ...
    index = "SV_Eternal~Portalcraft~Minion~3~3~3~~Surveillance System"
    requireTarget, effects, description = False, "", "Once on each of your opponent's turns, when they play a card, put a Paradigm Shift into your hand."
    attackAdd, healthAdd = 2, 2
    name_CN = "间谍装置"
...
class CourageousPuppeteer(SVMinion):
    ...
    mana, attack, health = 3, 2, 3
    index = "SV_Eternal~Portalcraft~Minion~3~2~3~~Courageous Puppeteer~Battlecry"
...
class KittyCatArsenal(SVSpell):
    Class, school, name = "Portalcraft", "", "Kitty-Cat Arsenal"
...
class ToyMender(SVMinion):
    ...
    index = "SV_Eternal~Portalcraft~Minion~6~2~4~~Toy Mender~Battlecry"
    requireTarget, effects, description = False, "", "Fanfare: Summon a Barrier Artifact."
    attackAdd, healthAdd = 2, 2
    name_CN = "玩具修缮师"
...
class MobilizedFactory_Crystallize(Amulet):
    ...
    mana = 5
    index = "SV_Eternal~Portalcraft~Amulet~5~~Mobilized Factory~Crystallize~Uncollectible"
...
SV_Eternal_Indices = {
    "SV_Eternal~Neutral~Minion~2~2~2~~Master Sleuth~Battlecry~Enhance": MasterSleuth,
    "SV_Eternal~Neutral~Minion~2~1~1~~Vyrn, Li'l Red Dragon~Battlecry~Enhance": VyrnLilRedDragon,
    "SV_Eternal~Neutral~Spell~2~Angelic Melody": AngelicMelody,
    "SV_Eternal~Neutral~Minion~2~1~2~~Io, Journeymage~Battlecry~Enhance": IoJourneymage,
    "SV_Eternal~Neutral~Minion~2~2~1~~Archangel of Remembrance~Battlecry": ArchangelofRemembrance,
    "SV_Eternal~Neutral~Minion~3~2~3~~Fluffy Angel~Battlecry~Deathrattle": FluffyAngel,
    "SV_Eternal~Neutral~Minion~3~2~3~~Eugen, Stalwart Skyfarer": EugenStalwartSkyfarer,
    ...
    "SV_Eternal~Neutral~Minion~5~5~5~~Gran & Djeeta, Eternal Heroes~Charge~Legendary~Uncollectible": GranDjeetaEternalHeroes,
    ...
    "SV_Eternal~Neutral~Minion~10~12~10~~Bahamut, Primeval Dragon~Battlecry~Accelerate~Legendary": BahamutPrimevalDragon,

    "SV_Eternal~Forestcraft~Minion~1~1~1~~Walder, Forest Ranger~Charge~Battlecry~Enhance~Invocation": WalderForestRanger,
    "SV_Eternal~Forestcraft~Minion~2~2~2~~Elf Sorcerer~Battlecry": ElfSorcerer,
    "SV_Eternal~Forestcraft~Minion~2~2~2~~Mimlemel, Freewheeling Lass~Battlecry": MimlemelFreewheelingLass,
    "SV_Eternal~Forestcraft~Minion~4~4~1~~Stumpeye~Rush~Uncollectible": Stumpeye,
    "SV_Eternal~Forestcraft~Minion~4~1~6~~Blossom Treant~Deathrattle": BlossomTreant,
    "SV_Eternal~Forestcraft~Minion~4~4~4~~Astoreth~Taunt~Battlecry": Astoreth,
    "SV_Eternal~Forestcraft~Minion~4~3~3~~Tweyen, Dark Huntress~Bane~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary": TweyenDarkHuntress,
    "SV_Eternal~Forestcraft~Minion~5~5~5~~Greenwood Reindeer~Rush~Battlecry": GreenwoodReindeer,
    "SV_Eternal~Forestcraft~Amulet~1~~Xeno Sagittarius~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible": XenoSagittarius_Crystallize,
    "SV_Eternal~Forestcraft~Minion~6~6~4~~Xeno Sagittarius~Battlecry~Crystallize~Legendary": XenoSagittarius,
    "SV_Eternal~Forestcraft~Spell~6~Nature Consumed": NatureConsumed,
    "SV_Eternal~Forestcraft~Minion~7~4~6~~Primordial Colossus~Battlecry": PrimordialColossus,
    "SV_Eternal~Forestcraft~Spell~1~Wind Fairy~Accelerate~Uncollectible": WindFairy_Accelerate,
    "SV_Eternal~Forestcraft~Minion~9~3~3~~Wind Fairy~Charge~Windfury~Accelerate": WindFairy,
    ...
    "SV_Eternal~Swordcraft~Amulet~2~~Ageworn Weaponry~Countdown~Deathrattle~Uncollectible": AgewornWeaponry,
    "SV_Eternal~Swordcraft~Amulet~2~~Greatshield~Countdown~Battlecry~Deathrattle~Uncollectible": Greatshield,
    "SV_Eternal~Swordcraft~Amulet~2~~Greatsword~Countdown~Battlecry~Deathrattle~Uncollectible": Greatsword,
    ...
    "SV_Eternal~Runecraft~Minion~1~0~1~~Alistair, Tiny Magus~Battlecry~Deathrattle": AlistairTinyMagus,
    "SV_Eternal~Runecraft~Spell~1~Impalement Arts~Spellboost": ImpalementArts,
    "SV_Eternal~Runecraft~Minion~2~3~1~~Elmott, Pyrestarter~Battlecry~Spellboost": ElmottPyrestarter,
    "SV_Eternal~Runecraft~Spell~2~Elixir Mixer": ElixirMixer,
    "SV_Eternal~Runecraft~Spell~2~Force Barrier": ForceBarrier,
    "SV_Eternal~Runecraft~Minion~3~2~3~~Academic Archmage~Battlecry": AcademicArchmage,
    "SV_Eternal~Runecraft~Minion~3~2~3~~Fif, Prodigious Sorcerer~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary": FifProdigiousSorcerer,
    "SV_Eternal~Runecraft~Minion~5~2~3~~Crystal Witch~Battlecry~Spellboost": CrystalWitch,
    "SV_Eternal~Runecraft~Amulet~3~~Xeno Ifrit~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible": XenoIfrit_Crystallize,
    "SV_Eternal~Runecraft~Minion~6~5~4~~Xeno Ifrit~Crystallize~Legendary": XenoIfrit,
    "SV_Eternal~Runecraft~Minion~7~4~4~~Pholia, Retired Sovereign~Battlecry": PholiaRetiredSovereign,
    "SV_Eternal~Runecraft~Minion~7~4~6~~Bai Ze~Rush~Taunt~Uncollectible": BaiZe,
    "SV_Eternal~Runecraft~Amulet~2~Earth Sigil~Raging Golem~Crystallize~Deathrattle~Uncollectible": RagingGolem_Crystallize,
    "SV_Eternal~Runecraft~Minion~8~6~6~~Raging Golem~Rush~Crystallize~Deathrattle": RagingGolem,

    "SV_Eternal~Dragoncraft~Spell~1~Dragon Rearing": DragonRearing,
    "SV_Eternal~Dragoncraft~Minion~2~2~2~~Shark Warrior~Battlecry~Enhance": SharkWarrior,
    "SV_Eternal~Dragoncraft~Minion~2~0~5~~Mermaid Archer~Battlecry~Enhance": MermaidArcher,
    "SV_Eternal~Dragoncraft~Minion~4~3~2~~Hypersonic Dragonewt~Charge~Battlecry": HypersonicDragonewt,
    "SV_Eternal~Dragoncraft~Minion~4~4~4~~Hypersonic Dragonewt~Bane~Battlecry": HypersonicDragonewt,
    "SV_Eternal~Dragoncraft~Minion~4~2~4~~Razia, Vengeful Cannonlancer~Taunt~Deathrattle": RaziaVengefulCannonlancer,
    "SV_Eternal~Dragoncraft~Minion~4~4~3~~Threo, Divine Havoc~Rush~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary": ThreoDivineHavoc,
    "SV_Eternal~Dragoncraft~Minion~5~5~5~~Tempest Dragon": TempestDragon,
    "SV_Eternal~Dragoncraft~Minion~6~4~6~~Ladiva, Champion of Love~Battlecry": LadivaChampionofLove,
    "SV_Eternal~Dragoncraft~Minion~9~8~7~~Ghandagoza, Fist of Rage~Rush": GhandagozaFistofRage,
    ...
    "SV_Eternal~Dragoncraft~Minion~17~13~13~~Disrestan, Ocean Harbinger~Battlecry~Legendary": DisrestanOceanHarbinger,

    "SV_Eternal~Shadowcraft~Minion~1~1~2~~Shao, Shady Apothecary~Battlecry~Necromancy": ShaoShadyApothecary,
    "SV_Eternal~Shadowcraft~Spell~1~Undead Parade": UndeadParade,
    "SV_Eternal~Shadowcraft~Minion~2~2~2~~Winged Zombie": WingedZombie,
    "SV_Eternal~Shadowcraft~Minion~2~2~1~~Psychopomp Tour Guide~Battlecry": PsychopompTourGuide,
    "SV_Eternal~Shadowcraft~Minion~2~1~4~~Niyon, Mystic Musician~Stealth~Taunt~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary": NiyonMysticMusician,
    "SV_Eternal~Shadowcraft~Minion~3~3~2~~Skullfish~Rush~Deathrattle": Skullfish,
    "SV_Eternal~Shadowcraft~Minion~3~1~1~~Tri-Head Hound~Deathrattle": TriHeadHound,
    "SV_Eternal~Shadowcraft~Minion~5~2~1~~Tri-Head Hound~Deathrattle~Uncollectible": TriHeadHound_Token,
    "SV_Eternal~Shadowcraft~Minion~7~3~1~~Tri-Head Hound~Uncollectible": TriHeadHound_Token2,
    "SV_Eternal~Shadowcraft~Minion~4~3~4~~Zaja, Delirious Berserker~Taunt~Battlecry": ZajaDeliriousBerserker,
    "SV_Eternal~Shadowcraft~Minion~6~4~5~~Lonesome Necromancer~Battlecry": LonesomeNecromancer,
    "SV_Eternal~Shadowcraft~Minion~7~4~7~~Vaseraga, Shadowed Scythe~Deathrattle": VaseragaShadowedScythe,
    "SV_Eternal~Shadowcraft~Minion~10~1~7~~Ruinblade Reaper~Bane~Necromancy~Legendary": RuinbladeReaper,

    "SV_Eternal~Bloodcraft~Minion~1~1~1~~Rouge Vampire~Drain~Battlecry": RougeVampire,
    "SV_Eternal~Bloodcraft~Minion~2~2~2~~Wicked Wolf~Bane~Battlecry~Enhance": WickedWolf,
    "SV_Eternal~Bloodcraft~Minion~2~2~1~~Skull, Freedom Raider~Rush~Battlecry": SkullFreedomRaider,
    "SV_Eternal~Bloodcraft~Minion~3~2~1~~Hallessena, Calamity's Saw~Battlecry": HallessenaCalamitysSaw,
    "SV_Eternal~Bloodcraft~Spell~3~Corrupting Bloodlust": CorruptingBloodlust,
    "SV_Eternal~Bloodcraft~Minion~4~3~3~~Discerning Devil~Battlecry~Deathrattle": DiscerningDevil,
    "SV_Eternal~Bloodcraft~Minion~4~2~8~~Gluttonous Demon": GluttonousDemon,
    "SV_Eternal~Bloodcraft~Minion~4~4~4~~Knight of Purgatory~Taunt~Battlecry~Invocation": KnightofPurgatory,
    "SV_Eternal~Bloodcraft~Minion~5~5~5~~Demonic Berserker~Rush~Battlecry": DemonicBerserker,
    "SV_Eternal~Bloodcraft~Minion~6~4~2~~Seox, Heavenly Howl~Rush~Windfury~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary": SeoxHeavenlyHowl,
    "SV_Eternal~Bloodcraft~Amulet~3~~Xeno Diablo~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible": XenoDiablo_Crystallize,
    "SV_Eternal~Bloodcraft~Minion~7~10~2~~Xeno Diablo~Deathrattle~Crystallize~Legendary": XenoDiablo,

    "SV_Eternal~Havencraft~Amulet~1~Battlecry~Summit Temple": SummitTemple,
    "SV_Eternal~Havencraft~Minion~1~1~2~~Will, Underworld Priest~Battlecry": WillUnderworldPriest,
    "SV_Eternal~Havencraft~Amulet~1~~Unicorn Altar~Countdown~Deathrattle": UnicornAltar,
    "SV_Eternal~Havencraft~Minion~6~5~5~~Unicorn~Battlecry~Uncollectible": Unicorn,
    "SV_Eternal~Havencraft~Minion~2~2~2~~Belfry Sister~Battlecry~Enhance": BelfrySister,
    "SV_Eternal~Havencraft~Minion~2~1~1~~Anre, the Enlightened One~Taunt~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary": AnretheEnlightenedOne,
    "SV_Eternal~Havencraft~Minion~3~1~5~~Zahlhamelina, Sun Priestess~Taunt": ZahlhamelinaSunPriestess,
    "SV_Eternal~Havencraft~Spell~4~Redeemer's Cudgel": RedeemersCudgel,
    "SV_Eternal~Havencraft~Minion~5~3~6~~Sword Al-mi'raj~Rush": SwordAlmiraj,
    "SV_Eternal~Havencraft~Amulet~3~~Xeno Vohu Manah~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible": XenoVohuManah_Crystallize,
    "SV_Eternal~Havencraft~Minion~5~2~6~~Xeno Vohu Manah~Crystallize~Legendary": XenoVohuManah,
    "SV_Eternal~Havencraft~Amulet~3~~Sacred Tiger~Countdown~Crystallize~Deathrattle~Uncollectible": SacredTiger_Crystallize,
    "SV_Eternal~Havencraft~Minion~7~3~3~~Sacred Tiger~Charge~Crystallize": SacredTiger,
    "SV_Eternal~Havencraft~Minion~3~3~2~~White Tiger~Taunt~Uncollectible": WhiteTiger,
    "SV_Eternal~Havencraft~Amulet~1~~Noa, Primal Shipwright~Countdown~Crystallize~Deathrattle~Uncollectible": NoaPrimalShipwright_Crystallize,
    "SV_Eternal~Havencraft~Minion~7~1~1~~Noa, Primal Shipwright~Taunt~Crystallize": NoaPrimalShipwright,

    "SV_Eternal~Portalcraft~Minion~2~2~2~~Mechanized Soldier~Battlecry~Enhance": MechanizedSoldier,
    "SV_Eternal~Portalcraft~Minion~2~2~1~~Catherine, Nightsmoke~Stealth~Battlecry": CatherineNightsmoke,
    "SV_Eternal~Portalcraft~Minion~2~1~3~~Spinnah, Spin Artist~Battlecry~Enhance": SpinnahSpinArtist,
    "SV_Eternal~Portalcraft~Minion~2~2~2~~Lunalu, Fangirl A": LunaluFangirlA,
    "SV_Eternal~Portalcraft~Spell~1~Facsimile~Uncollectible": Facsimile,
    "SV_Eternal~Portalcraft~Minion~2~4~2~~Feower, Double Blade Flash~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary": FeowerDoubleBladeFlash,
    "SV_Eternal~Portalcraft~Minion~3~2~4~~Tien, Treacherous Trigger~Battlecry~SkyboundArt~SuperSkyboundArt~Legendary": TienTreacherousTrigger,
    "SV_Eternal~Portalcraft~Minion~3~3~3~~Surveillance System": SurveillanceSystem,
    "SV_Eternal~Portalcraft~Minion~3~2~3~~Courageous Puppeteer~Battlecry": CourageousPuppeteer,
    "SV_Eternal~Portalcraft~Spell~3~Kitty-Cat Arsenal": KittyCatArsenal,
    "SV_Eternal~Portalcraft~Minion~6~2~4~~Toy Mender~Battlecry": ToyMender,
    "SV_Eternal~Portalcraft~Amulet~5~~Mobilized Factory~Crystallize~Uncollectible": MobilizedFactory_Crystallize,
    "SV_Eternal~Portalcraft~Minion~10~6~6~~Mobilized Factory~Battlecry~Crystallize": MobilizedFactory,
}