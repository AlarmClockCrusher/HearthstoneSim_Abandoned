...
from Core import TheCoin, SilverHandRecruit
...
class MurlocTinyfin(Minion):
	...
	index = "Core_2021~Neutral~Minion~0~1~1~Murloc~Murloc Tinyfin"
...
class AbusiveSergeant(Minion):
	...
	index = "Core_2021~Neutral~Minion~1~1~1~~Abusive Sergeant~Battlecry"
...
class ArcaneAnomaly(Minion):
	...
	index = "Core_2021~Neutral~Minion~1~2~1~Elemental~Arcane Anomaly"
...
class ArgentSquire(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Neutral~Minion~1~1~1~~Argent Squire~Divine Shield"
	requireTarget, keyWord, description = False, "Divine Shield", "Divine Shield"
	name_CN = "银色侍从"
	

class Cogmaster(Minion):
	Class, race, name = "Shaman", "", "Cogmaster"
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Shaman~Minion~1~1~2~~Cogmaster"
...
class ElvenArcher(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Neutral~Minion~1~1~1~~Elven Archer~Battlecry"
...
class MurlocTidecaller(Minion):
	...
	index = "Core_2021~Neutral~Minion~1~1~2~Murloc~Murloc Tidecaller"
...
class StonetuskBoar(Minion):
	...
	mana, attack, health = 1, 2, 1
	index = "Core_2021~Neutral~Minion~1~2~1~Beast~Stonetusk Boar~Rush"
...
class VoodooDoctor(Minion):
	...
	mana, attack, health = 1, 2, 1
	index = "Core_2021~Neutral~Minion~1~2~1~~Voodoo Doctor~Battlecry"
...
class WorgenInfiltrator(Minion):
	...
	mana, attack, health = 1, 2, 1
	index = "Core_2021~Neutral~Minion~1~2~1~~Worgen Infiltrator~Stealth"
...
class YoungPriestess(Minion):
	...
	mana, attack, health = 1, 2, 1
	index = "Core_2021~Neutral~Minion~1~2~1~~Young Priestess"
...
class AcidicSwampOoze(Minion):
	...
	index = "Core_2021~Neutral~Minion~2~3~2~~Acidic Swamp Ooze~Battlecry"
...
class BloodmageThalnos(Minion):
	...
	index = "Core_2021~Neutral~Minion~2~1~1~~Bloodmage Thalnos~Deathrattle~Spell Damage~Legendary"
...
class BloodsailRaider(Minion):
	...
	index = "Core_2021~Neutral~Minion~2~2~3~Pirate~Bloodsail Raider~Battlecry"
...
class BluegillWarrior(Minion):
	...
	index = "Core_2021~Neutral~Minion~2~3~1~Murloc~Bluegill Warrior~Rush"
	requireTarget, keyWord, description = False, "Rush", "Rush"
	name_CN = "蓝鳃战士"
...
class CrazedAlchemist(Minion):
	...
	index = "Core_2021~Neutral~Minion~2~2~2~~Crazed Alchemist~Battlecry"
...
class DireWolfAlpha(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Neutral~Minion~2~2~2~Beast~Dire Wolf Alpha"
...
class ExplosiveSheep(Minion):
	...
	mana, attack, health = 2, 1, 1
	index = "Core_2021~Neutral~Minion~2~1~1~Mech~Explosive Sheep~Deathrattle"
...
class FogsailFreebooter(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Neutral~Minion~2~2~2~Pirate~Fogsail Freebooter~Battlecry"
...
class NerubianEgg(Minion):
	...
	index = "Core_2021~Neutral~Minion~2~0~2~~Nerubian Egg~Deathrattle"
...
class Nerubian(Minion):
	...
	index = "Core_2021~Neutral~Minion~4~4~4~~Nerubian~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "蛛魔"
...
class RiverCrocolisk(Minion):
	...
	mana, attack, health = 2, 2, 3
	index = "Core_2021~Neutral~Minion~2~2~3~Beast~River Crocolisk"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "淡水鳄"
...
class SunreaverSpy(Minion):
	...
	mana, attack, health = 2, 2, 3
	index = "Core_2021~Neutral~Minion~2~2~3~~Sunreaver Spy~Battlecry"
...
class Toxicologist(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Neutral~Minion~2~2~2~~Toxicologist~Battlecry"
...
class YouthfulBrewmaster(Minion):
	...
	mana, attack, health = 2, 3, 2
	index = "Core_2021~Neutral~Minion~2~3~2~~Youthful Brewmaster~Battlecry"
...
class Brightwing(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~3~2~Dragon~Brightwing~Battlecry~Legendary"
...
class ColdlightSeer(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~2~3~Murloc~Coldlight Seer~Battlecry"
...
class EarthenRingFarseer(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~3~3~~Earthen Ring Farseer~Battlecry"
...
class FlesheatingGhoul(Minion):
	...
	mana, attack, health = 3, 2, 3
	index = "Core_2021~Neutral~Minion~3~2~3~~Flesheating Ghoul"
...
class HumongousRazorleaf(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~4~8~~Humongous Razorleaf"
...
class IceRager(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~5~2~Elemental~Ice Rager"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "冰霜暴怒者"
...
class InjuredBlademaster(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~4~7~~Injured Blademaster~Battlecry"
...
class IronbeakOwl(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~2~1~Beast~Ironbeak Owl~Battlecry"
...
class JunglePanther(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~4~2~Beast~Jungle Panther~Stealth"
	requireTarget, keyWord, description = False, "Stealth", "Stealth"
	name_CN = "丛林猎豹"
...
class KingMukla(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~5~5~Beast~King Mukla~Battlecry~Legendary"
...
class Bananas(Spell):
	...
	index = "Core_2021~Neutral~Spell~1~Bananas~Uncollectible"
...
class LoneChampion(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~2~4~~Lone Champion~Battlecry"
...
class MiniMage(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~3~1~~Mini-Mage~Stealth~Spell Damage"
...
class RaidLeader(Minion):
	...
	mana, attack, health = 3, 2, 3
	index = "Core_2021~Neutral~Minion~3~2~3~~Raid Leader"
...
class SouthseaCaptain(Minion):
	...
	mana, attack, health = 3, 3, 3
	index = "Core_2021~Neutral~Minion~3~3~3~Pirate~Southsea Captain"
...
class SpiderTank(Minion):
	...
	index = "Core_2021~Neutral~Minion~3~3~4~Mech~Spider Tank"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "蜘蛛坦克"
...
class StoneskinBasilisk(Minion):
	...
	mana, attack, health = 3, 3, 4
	index = "Core_2021~Neutral~Minion~3~3~4~Beast~Stoneskin Basilisk~Divine Shield~Poisonous"
...
class BaronRivendare(Minion):
	...
	index = "Core_2021~Neutral~Minion~4~1~7~~Baron Rivendare~Legendary"
...
class BigGameHunter(Minion):
	...
	index = "Core_2021~Neutral~Minion~5~4~2~~Big Game Hunter~Battlecry"
...
class ChillwindYeti(Minion):
	...
	index = "Core_2021~Neutral~Minion~4~4~5~~Chillwind Yeti"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "冰风雪人"
...
class DarkIronDwarf(Minion):
	...
	mana, attack, health = 4, 4, 4
	index = "Core_2021~Neutral~Minion~4~4~4~~Dark Iron Dwarf~Battlecry"
...
class DefenderofArgus(Minion):
	...
	index = "Core_2021~Neutral~Minion~4~2~3~~Defender of Argus~Battlecry"
...
class GrimNecromancer(Minion):
	...
	index = "Core_2021~Neutral~Minion~4~2~4~~Grim Necromancer~Battlecry"
...
class Skeleton(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Neutral~Minion~1~1~1~~Skeleton~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "骷髅"
...
class SenjinShieldmasta(Minion):
	...
	index = "Core_2021~Neutral~Minion~4~3~5~~Sen'jin Shieldmasta~Taunt"
...
class VioletTeacher(Minion):
	...
	mana, attack, health = 4, 3, 5
	index = "Core_2021~Neutral~Minion~4~3~5~~Violet Teacher"
...
class VioletApprentice(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Neutral~Minion~1~1~1~~Violet Apprentice~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "紫罗兰学徒"
...
class FacelessManipulator(Minion):
	...
	index = "Core_2021~Neutral~Minion~5~3~3~~Faceless Manipulator~Battlecry"
...
class GurubashiBerserker(Minion):
	...
	index = "Core_2021~Neutral~Minion~5~2~8~~Gurubashi Berserker"
...
class StranglethornTiger(Minion):
	...
	index = "Core_2021~Neutral~Minion~5~5~5~Beast~Stranglethorn Tiger~Stealth"
	requireTarget, keyWord, description = False, "Stealth", "Stealth"
	name_CN = "荆棘谷猛虎"
...
class TaelanFordring(Minion):
	...
	mana, attack, health = 5, 3, 3
	index = "Core_2021~Neutral~Minion~5~3~3~~Taelan Fordring~Taunt~Divine Shield~Deathrattle~Legendary"
...
class CairneBloodhoof(Minion):
	...
	index = "Core_2021~Neutral~Minion~6~5~5~~Cairne Bloodhoof~Deathrattle~Legendary"
...
class BaineBloodhoof(Minion):
	...
	mana, attack, health = 5, 5, 5
	index = "Core_2021~Neutral~Minion~5~5~5~~Baine Bloodhoof~Legendary~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "贝恩·血蹄"
...
class HighInquisitorWhitemane(Minion):
	...
	index = "Core_2021~Neutral~Minion~6~5~7~~High Inquisitor Whitemane~Battlecry~Legendary"
...
class BaronGeddon(Minion):
	...
	index = "Core_2021~Neutral~Minion~7~7~7~Elemental~Baron Geddon~Legendary"
...
class BarrensStablehand(Minion):
	...
	index = "Core_2021~Neutral~Minion~7~5~5~~Barrens Stablehand~Battlecry"
...
class NozdormutheEternal(Minion):
	...
	index = "Core_2021~Neutral~Minion~7~8~8~Dragon~Nozdormu the Eternal~Legendary"
...
class Stormwatcher(Minion):
	...
	index = "Core_2021~Neutral~Minion~7~4~8~Elemental~Stormwatcher~Windfury"
...
class StormwindChampion(Minion):
	...
	mana, attack, health = 7, 7, 7
	index = "Core_2021~Neutral~Minion~7~7~7~~Stormwind Champion"
...
class ArcaneDevourer(Minion):
	...
	index = "Core_2021~Neutral~Minion~8~4~8~Elemental~Arcane Devourer"
...
class OnyxiatheBroodmother(Minion):
	...
	index = "Core_2021~Neutral~Minion~9~8~8~Dragon~Onyxia, the Broodmother~Legendary"
...
class Trig_OnyxiatheBroodmother(TrigBoard):
	...
	def effect(self, signal, ID, subject, target, number, comment, choice=0):
		self.entity.Game.summon([Whelp(self.entity.Game, self.entity.ID) for i in range(6)], (self.entity.pos, "leftandRight"), self.entity)
		
class Whelp(Minion):
	Class, race, name = "Neutral", "Dragon", "Whelp"
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Neutral~Minion~1~1~1~Dragon~Whelp~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "雏龙"
...
class SleepyDragon(Minion):
	...
	mana, attack, health = 9, 4, 12
	index = "Core_2021~Neutral~Minion~9~4~12~Dragon~Sleepy Dragon~Taunt"
	requireTarget, keyWord, description = False, "Taunt", "Taunt"
	name_CN = "贪睡巨龙"
...
class Dream(Spell):
	...
	requireTarget, mana = True, 1
	index = "Core_2021~DreamCard~Spell~1~Nature~Dream~Uncollectible"
...
class Nightmare(Spell):
	...
	index = "Core_2021~DreamCard~Spell~0~Shadow~Nightmare~Uncollectible"
...
class YseraAwakens(Spell):
	...
	index = "Core_2021~DreamCard~Spell~3~Nature~Ysera Awakens~Uncollectible"
...
class LaughingSister(Minion):
	...
	index = "Core_2021~DreamCard~Minion~2~3~5~~Laughing Sister~Uncollectible"
...
class EmeraldDrake(Minion):
	...
	index = "Core_2021~DreamCard~Minion~4~7~6~Dragon~Emerald Drake~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "翡翠幼龙"
...
class ClockworkGiant(Minion):
	Class, race, name = "Neutral", "Mech", "lockwork Giant"
	mana, attack, health = 12, 8, 8
	index = "Core_2021~Neutral~Minion~12~8~8~Mech~lockwork Giant"
	needTarget, keyWord, description = False, "", "Costs (1) less for each other card in your opponent's hand"
	def __init__(self, Game, ID):
		self.blank_init(Game, ID)
		self.triggersinHand = [Trigger_ClockworkGiant(self)]
		
	def selfManaChange(self):
		if self.inHand:
			manaReduction = len(self.Game.Hand_Deck.hands[3-self.ID]) - 1
...
class Battlefiend(Minion):
	...
	mana, attack, health = 1, 1, 2
	index = "Core_2021~Demon Hunter~Minion~1~1~2~Demon~Battlefiend"
...
class ChaosStrike(Spell):
	...
	index = "Core_2021~Demon Hunter~Spell~2~Chaos Strike"
...
class CrimsonSigilRunner(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Demon Hunter~Minion~1~1~1~~Crimson Sigil Runner~Outcast"
...
class FeastofSouls(Spell):
	...
	requireTarget, mana = False, 2
	index = "Core_2021~Demon Hunter~Spell~2~Feast of Souls"
...
class KorvasBloodthorn(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Demon Hunter~Minion~2~2~2~None~Kor'vas Bloodthorn~Charge~Lifesteal~Legendary"
...
class SightlessWatcher(Minion):
	...
	mana, attack, health = 2, 3, 2
	index = "Core_2021~Demon Hunter~Minion~2~3~2~Demon~Sightless Watcher~Battlecry"
...
class SpectralSight(Spell):
	...
	requireTarget, mana = False, 2
	index = "Core_2021~Demon Hunter~Spell~2~Spectral Sight~Outcast"
...
class AldrachiWarblades(Weapon):
	...
	index = "Core_2021~Demon Hunter~Weapon~3~2~2~Aldrachi Warblades~Lifesteal"
	name_CN = "奥达奇战刃"
	def __init__(self, Game, ID):
		self.blank_init(Game, ID)
...
class CoordinatedStrike(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Demon Hunter~Spell~3~Coordinated Strike"
...
class IllidariInitiate(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Demon Hunter~Minion~1~1~1~~Illidari Initiate~Rush~Uncollectible"
	requireTarget, keyWord, description = False, "Rush", "Rush"
	name_CN = "伊利达雷 新兵"
...
class EyeBeam(Spell):
	...
	index = "Core_2021~Demon Hunter~Spell~3~Eye Beam~Outcast"
...
class GanargGlaivesmith(Minion):
	Class, race, name = "Demon Hunter", "", "Gan'arg Glaivesmith"
	mana, attack, health = 3, 3, 2
	index = "Core_2021~Demon Hunter~Minion~3~3~2~~Gan'arg Glaivesmith~Outcast"
...
class AshtongueBattlelord(Minion):
	...
	mana, attack, health = 4, 3, 5
	index = "Core_2021~Demon Hunter~Minion~4~3~5~~Ashtongue Battlelord~Taunt~Lifesteal"
...
class RagingFelscreamer(Minion):
	...
	mana, attack, health = 4, 4, 4
	index = "Core_2021~Demon Hunter~Minion~4~4~4~~Raging Felscreamer~Battlecry"
...
class ChaosNova(Spell):
	...
	index = "Core_2021~Demon Hunter~Spell~5~Chaos Nova"
...
class WarglaivesofAzzinoth(Weapon):
	...
	index = "Core_2021~Demon Hunter~Weapon~5~3~3~Warglaives of Azzinoth"
	name_CN = "埃辛诺斯战刃"
	def __init__(self, Game, ID):
		self.blank_init(Game, ID)
...
class IllidariInquisitor(Minion):
	...
	index = "Core_2021~Demon Hunter~Minion~8~8~8~Demon~Illidari Inquisitor~Rush"
...
class Trig_IllidariInquisitor(TrigBoard):
	def __init__(self, entity):
		self.blank_init(entity, ["HeroAttackedMinion", "HeroAttackeHero"])
...
class Innervate(Spell):
	...
	index = "Core_2021~Druid~Spell~0~Nature~Innervate"
...
class Pounce(Spell):
	...
	requireTarget, mana = False, 0
	index = "Core_2021~Druid~Spell~0~~Pounce"
...
class EnchantedRaven(Minion):
	...
	index = "Core_2021~Druid~Minion~1~2~2~Beast~Enchanted Raven"
	requireTarget, keyWord, description = False, "", ""
	description_CN = ""
	name_CN = "魔法乌鸦"
...
class MarkoftheWild(Spell):
	...
	index = "Core_2021~Druid~Spell~2~Nature~Mark of the Wild"
...
class PoweroftheWild(Spell):
	...
	requireTarget, mana = False, 2
	index = "Core_2021~Druid~Spell~2~~Power of the Wild~Choose One"
...
class LeaderofthePack_Option(ChooseOneOption):
	...
	index = "Core_2021~Druid~Spell~2~Leader of the Pack~Uncollectible"
	
class SummonaPanther_Option(ChooseOneOption):
	name, description = "Summon a Panther", "Summon a 3/2 Panther"
	index = "Core_2021~Druid~Spell~2~Summon a Panther~Uncollectible"
	def available(self):
...
class Panther(Minion):
	...
	mana, attack, health = 2, 3, 2
	index = "Core_2021~Druid~Minion~2~3~2~Beast~Panther~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "猎豹"
...
class FeralRage(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Druid~Spell~3~~Feral Rage~Choose One"
	description = "Choose One - Give your minions +1/+1; or Summon a 3/2 Panther"
	name_CN = "野性之怒"
	def __init__(self, Game, ID):
		self.blank_init(Game, ID)
...
class EvolveSpines_Option(ChooseOneOption):
	...
	index = "Core_2021~Druid~Spell~3~~EvolveSpines~Uncollectible"
	
class EvolveScales_Option(ChooseOneOption):
	name, description = "Evolve Scales", "Gain 8 Armor"
	index = "Core_2021~Druid~Spell~3~~Evolve Scales~Uncollectible"
	
class EvolveSpines(Spell):
	Class, school, name = "Druid", "", "Evolve Spines"
	requireTarget, mana = False, 3
	index = "Core_2021~Druid~Spell~3~~Evolve Spines~Uncollectible"
...
class Landscaping(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Druid~Spell~3~Nature~Landscapin"
	...
	def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
		self.Game.summon([Treant_Boomsday(self.Game, self.ID) for i in range(2)], (-1, "totheRightEnd"), self)
		return None
...
class Treant_Boomsday(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Druid~Minion~2~2~2~~Treant~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	description_CN = ""
	name_CN = "树人"
...
class WildGrowth(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Druid~Spell~3~Nature~Wild Growth"
...
class ExcessMana(Spell):
	...
	requireTarget, mana = False, 0
	index = "Core_2021~Druid~Spell~0~~Excess Mana~Uncollectible"
...
class NordrassilDruid(Minion):
	...
	mana, attack, health = 4, 3, 5
	index = "Core_2021~Druid~Minion~4~3~5~~Nordrassil Druid~Battlecry"
...
class SouloftheForest(Spell):
	...
	index = "Core_2021~Druid~Spell~4~Nature~Soul of the Forest"
...
class DruidoftheClaw(Minion):
	...
	index = "Core_2021~Druid~Minion~5~5~4~~Druid of the Claw~Choose One"
...
class CatForm_Option(ChooseOneOption):
	name, description = "Cat Form", "Rush"
...
class DruidoftheClaw_Charge(Minion):
	...
	mana, attack, health = 5, 5, 4
	index = "Core_2021~Druid~Minion~5~5~4~Beast~Druid of the Claw~Rush~Uncollectible"
	requireTarget, keyWord, description = False, "Rush", "Rush"
	name_CN = "利爪德鲁伊"
...
class DruidoftheClaw_Taunt(Minion):
	...
	index = "Core_2021~Druid~Minion~5~5~6~Beast~Druid of the Claw~Taunt~Uncollectible" 
	requireTarget, keyWord, description = False, "Taunt", "Taunt"
	name_CN = "利爪德鲁伊"
...
class DruidoftheClaw_Both(Minion):
	Class, race, name = "Druid", "Beast", "Druid of the Claw"
	mana, attack, health = 5, 5, 6
	index = "Core_2021~Druid~Minion~5~5~6~Beast~Druid of the Claw~Taunt~Rush~Uncollectible" 
...
class ForceofNature(Spell):
	...
	requireTarget, mana = False, 5
	index = "Core_2021~Druid~Spell~5~Force of Nature"
...
class Nourish(Spell):
	...
	index = "Core_2021~Druid~Spell~6~Nature~Nourish~Choose One"
...
class RampantGrowth_Option(ChooseOneOption):
	...
	index = "Core_2021~Druid~Spell~6~Nature~Rampant Growth~Uncollectible"
	
class Enrich_Option(ChooseOneOption):
	name, description = "Enrich", "Draw 3 cards"
	index = "Core_2021~Druid~Spell~6~Nature~Enrich~Uncollectible"
...
class AncientofWar(Minion):
	...
	mana, attack, health = 7, 5, 5
	index = "Core_2021~Druid~Minion~7~5~5~~Ancient of War~Choose One"
...
class Cenarius(Minion):
	...
	index = "Core_2021~Druid~Minion~8~5~8~~Cenarius~Choose One~Legendary"
...
class Treant_Classic_Taunt(Minion):
	Class, race, name = "Druid", "", "Treant"
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Druid~Minion~2~2~2~~Treant~Taunt~Uncollectible"
	requireTarget, keyWord, description = False, "Taunt", "Taunt"
	name_CN = "树人"
...
class ArcaneShot(Spell):
	...
	requireTarget, mana = True, 1
	index = "Core_2021~Hunter~Spell~1~Arcane~Arcane Shot"
...
class Tracking(Spell):
	...
	index = "Core_2021~Hunter~Spell~1~Tracking"
	...
	def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
		...
		if curGame.mode == 0:
			if curGame.guides:
				...
				types, inds = [type(card) for card in ownDeck], [range(ownDeck)]
				if "byOthers" in comment:
...
class Webspinner(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Neutral~Minion~1~1~1~Beast~Webspinner~Deathrattle"
...
class ExplosiveTrap(Secret):
	...
	requireTarget, mana = False, 2
	index = "Core_2021~Hunter~Spell~2~Explosive Trap~~Secret"
...
class FreezingTrap(Secret):
	...
	requireTarget, mana = False, 2
	index = "Core_2021~Hunter~Spell~2~Freezing Trap~~Secret"
...
class HeadhuntersHatchet(Weapon):
	...
	index = "Core_2021~Hunter~Weapon~2~2~2~Headhunter's Hatchet~Battlecry"
	name_CN = "猎头者之斧"
...
class QuickShot(Spell):
	...
	requireTarget, mana = True, 2
	index = "Core_2021~Hunter~Spell~2~~Quick Shot"
...
class ScavengingHyena(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Hunter~Minion~2~2~2~Beast~Scavenging Hyena"
...
class SelectiveBreeder(Minion):
	...
	mana, attack, health = 2, 1, 1
	index = "Core_2021~Hunter~Minion~2~1~1~~Selective Breeder~Battlecry"
	...
	def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
		...
		if curGame.mode == 0:
			if curGame.guides:
				i = curGame.guides.pop(0)
				if i > -1: curGame.Hand_Deck.addCardtoHand(ownDeck[i].selfCopy(self.ID), self.ID, creator=type(self))
			else:
				types, inds = [], []
	...
	def discoverDecided(self, option, pool):
		...
		i = ownDeck.index(option)
		self.Game.fixedGuides.append(i)
		self.Game.Hand_Deck.addCardtoHand(ownDeck[i].selfCopy(self.ID), self.ID, creator=type(self))
		
		
class SnakeTrap(Secret):
	Class, school, name = "Hunter", "", "Snake Trap"
	requireTarget, mana = False, 2
	index = "Core_2021~Hunter~Spell~2~Snake Trap~~Secret"
...
class Snake(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Hunter~Minion~1~1~1~Beast~Snake~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "蛇"
...
class Bearshark(Minion):
	...
	index = "Core_2021~Hunter~Minion~3~4~3~Beast~Bearshark"
...
class DeadlyShot(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Hunter~Spell~3~Deadly Shot"
...
class DireFrenzy(Spell):
	...
	index = "Core_2021~Hunter~Spell~4~~Dire Frenzy"
	...
	def whenEffective(self, target=None, comment="", choice=0, posinHand=0):
		if target:
			...
			for i in range(3):
				...
				card.buffDebuff(3, 3)
				cards.append(card)
			self.Game.Hand_Deck.shuffleCardintoDeck(cards, self.ID, creator=self)
		return target
...
class SavannahHighmane(Minion):
	...
	index = "Core_2021~Hunter~Minion~6~6~5~Beast~Savannah Highmane~Deathrattle"
...
class Hyena_Classic(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Hunter~Minion~2~2~2~Beast~Hyena~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "土狼"
...
class KingKrush(Minion):
	...
	mana, attack, health = 9, 8, 8
	index = "Core_2021~Hunter~Minion~9~8~8~Beast~King Krush~Charge~Legendary"
...
class BabblingBook(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Mage~Minion~1~1~1~~Babbling Book~Battlecry"
...
class ShootingStar(Spell):
	...
	requireTarget, mana = True, 1
	index = "Core_2021~Mage~Spell~1~Arcane~Shooting Star"
...
class SnapFreeze(Spell):
	Class, school, name = "Mage", "Frost", "Shooting Star"
	requireTarget, mana = True, 1
	index = "Core_2021~Mage~Spell~1~Frost~Shooting Star"
	description = "Deal 1 damage to a minion and its neighbors"
	name_CN = "急速冷冻"
	def available(self):
		return self.selectableMinionExists()
...
class Arcanologist(Minion):
	...
	mana, attack, health = 2, 2, 3
	index = "Core_2021~Mage~Minion~2~2~3~~Arcanologist~Battlecry"
...
class FallenHero(Minion):
	...
	mana, attack, health = 2, 3, 2
	index = "Core_2021~Mage~Minion~2~3~2~~Fallen Hero"
...
class ArcaneIntellect(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Mage~Spell~3~Arcane~Arcane Intellect"
...
class ConeofCold(Spell):
	...
	requireTarget, mana = True, 3
	index = "Core_2021~Mage~Spell~3~Frost~Cone of Cold"
...
class Counterspell(Secret):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Mage~Spell~3~Arcane~CounterSpell~~Secret"
...
class IceBarrier(Secret):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Mage~Spell~3~Frost~Ice Barrier~~Secret"
...
class MirrorEntity(Secret):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Mage~Spell~3~Arcane~Mirror Entity~~Secret"
...
class WaterElemental(Minion):
	...
	index = "Core_2021~Mage~Minion~4~3~6~Elemental~Water Elemental"
...
class AegwynntheGuardian(Minion):
	...
	mana, attack, health = 5, 5, 5
	index = "Core_2021~Neutral~Minion~5~5~5~~Aegwynn, the Guardian~Spell Damage~Deathrattle"
...
class AegwynntheGuardian_Effect:
	...
	def trig(self, signal, ID, subject, target, number, comment, choice=0):
		if self.canTrig(signal, ID, subject, target, number, comment):
			if self.Game.GUI: self.Game.GUI.showOffBoardTrig(AegwynntheGuardian(self.Game, self.ID), linger=False)
...
class EtherealConjurer(Minion):
	...
	index = "Core_2021~Mage~Minion~5~6~4~~Ethereal Conjurer~Battlecry"
...
class ColdarraDrake(Minion):
	...
	index = "Core_2021~Mage~Minion~6~6~7~Dragon~Coldarra Drake"
...
class GameRuleAura_ColdarraDrake(GameRuleAura):
	def auraAppears(self):
		...
		if self.entity.Game.GUI: self.entity.Game.GUI.checkHeroPower()
...
class Flamestrike(Spell):
	...
	index = "Core_2021~Mage~Spell~7~Fire~Flamestrike"
...
class Avenge(Secret):
	...
	requireTarget, mana = False, 1
	index = "Core_2021~Paladin~Spell~1~Holy~Avenge~~Secret"
...
class NobleSacrifice(Secret):
	...
	requireTarget, mana = False, 1
	index = "Core_2021~Paladin~Spell~1~Noble Sacrifice~~Secret"
...
class Defender(Minion):
	...
	mana, attack, health = 1, 2, 1
	index = "Core_2021~Paladin~Minion~1~2~1~~Defender~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "防御者"
...
class Reckoning(Secret):
	...
	requireTarget, mana = False, 1
	index = "Core_2021~Paladin~Spell~1~Reckoning~~Secret"
...
class Trig_Reckoning(SecretTrigger):
	def __init__(self, entity):
		self.blank_init(entity, ["DealtDmg"])
...
class RighteousProtector(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Paladin~Minion~1~1~1~~Righteous Protector~Taunt~Divine Shield"
	requireTarget, keyWord, description = False, "Taunt,Divine Shield", "Taunt, Divine Shield"
	name_CN = "正义保护者"
...
class ArgentProtector(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Paladin~Minion~2~2~2~~Argent Protector~Battlecry"
...
class HolyLight(Spell):
	...
	requireTarget, mana = True, 2
	index = "Core_2021~Paladin~Spell~2~Holy~Holy Light"
...
class PursuitofJustice(Spell):
	...
	requireTarget, mana = False, 2
	index = "Core_2021~Paladin~Spell~2~Holy~Pursuit of Justice"
...
class AldorPeacekeeper(Minion):
	...
	mana, attack, health = 3, 3, 3
	index = "Core_2021~Paladin~Minion~3~3~3~~Aldor Peacekeeper~Battlecry"
...
class Equality(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Paladin~Spell~3~Holy~Equality"
...
class WarhorseTrainer(Minion):
	...
	mana, attack, health = 3, 3, 4
	index = "Core_2021~Paladin~Minion~3~3~4~Murloc~Warhorse Trainer"
...
class BlessingofKings(Spell):
	...
	requireTarget, mana = True, 4
	index = "Core_2021~Paladin~Spell~4~Holy~Blessing of Kings"
...
class Consecration(Spell):
	...
	requireTarget, mana = False, 4
	index = "Core_2021~Paladin~Spell~4~Holy~Consecration"
...
class TruesilverChampion(Weapon):
	...
	index = "Core_2021~Paladin~Weapon~4~4~2~Truesilver Champion"
	name_CN = "真银圣剑"
	def __init__(self, Game, ID):
		self.blank_init(Game, ID)
...
class StandAgainstDarkness(Spell):
	...
	requireTarget, mana = False, 5
	index = "Core_2021~Paladin~Spell~5~~Coordinated Strike"
	description = "Summon five 1/1 Silver Hand Recruits"
	name_CN = "惩黑除恶"
	def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
		self.Game.summon([SilverHandRecruit(self.Game, self.ID) for i in range(5)], (-1, "totheRightEnd"), self.ID)
		return None
...
class GuardianofKings(Minion):
	...
	index = "Core_2021~Paladin~Minion~7~5~7~~Guardian of Kings~Battlecry"
...
class CrimsonClergy(Minion):
	...
	index = "Core_2021~Priest~Minion~1~1~3~~Crimson Clergy"
...
class Trig_LightWarden(TrigBoard):
	def __init__(self, entity):
		self.blank_init(entity, ["MinionGotHealed", "HeroGotHealed"])
...
class FlashHeal(Spell):
	...
	requireTarget, mana = True, 1
	index = "Core_2021~Priest~Spell~1~Holy~Flash Heal"
...
class FocusedWill(Spell):
	...
	requireTarget, mana = True, 1
	index = "Core_2021~Priest~Spell~1~~Focused Will"
...
class HolySmite(Spell):
	...
	requireTarget, mana = True, 1
	index = "Core_2021~Priest~Spell~1~Holy Smite"
...
class PsychicConjurer(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Priest~Minion~1~1~1~~Psychic Conjurer~Battlecry"
...
class ShadowWordDeath(Spell):
	...
	requireTarget, mana = True, 2
	index = "Core_2021~Priest~Spell~2~Shadow~Shadow Word: Death"
...
class Lightspawn(Minion):
	...
	index = "Core_2021~Priest~Minion~3~0~4~Elemental~Lightspawn"
...
class Shadowform(Spell):
	...
	index = "Core_2021~Priest~Spell~2~Shadow~Shadowform"
...
class HolyNova(Spell):
	...
	requireTarget, mana = False, 4
	index = "Core_2021~Priest~Spell~4~Holy~Holy Nova"
...
class PowerInfusion(Spell):
	...
	requireTarget, mana = True, 4
	index = "Core_2021~Priest~Spell~4~Power Infusion"
...
class ShadowWordRuin(Spell):
	...
	requireTarget, mana = False, 4
	index = "Core_2021~Priest~Spell~4~Shadow Word: Ruin"
...
class TempleEnforcer(Minion):
	...
	mana, attack, health = 5, 5, 6
	index = "Core_2021~Priest~Minion~5~5~6~~Temple Enforcer~Battlecry"
...
class NatalieSeline(Minion):
	...
	index = "Core_2021~Priest~Minion~8~8~1~~Natalie Seline~Battlecry"
...
class Backstab(Spell):
	...
	requireTarget, mana = True, 0
	index = "Core_2021~Rogue~Spell~0~~Backstab"
...
class Preparation(Spell):
	...
	requireTarget, mana = False, 0
	index = "Core_2021~Rogue~Spell~0~Preparation"
...
class Shadowstep(Spell):
	...
	requireTarget, mana = True, 0
	index = "Core_2021~Rogue~Spell~0~Shadow~Shadowstep"
...
class BladedCultist(Minion):
	...
	mana, attack, health = 1, 1, 2
	index = "Core_2021~Rogue~Minion~1~1~2~~Bladed Cultist~Combo"
...
class DeadlyPoison(Spell):
	...
	requireTarget, mana = False, 1
	index = "Core_2021~Rogue~Spell~1~Nature~Deadly Poison"
...
class SinisterStrike(Spell):
	...
	requireTarget, mana = False, 1
	index = "Core_2021~Rogue~Spell~1~Sinister Strike"
...
class Swashburglar(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Rogue~Minion~1~1~1~Pirate~Swashburglar~Battlecry"
...
class ColdBlood(Spell):
	...
	requireTarget, mana = True, 2
	index = "Core_2021~Rogue~Spell~2~~Cold Blood~Combo"
...
class PatientAssassin(Minion):
	...
	mana, attack, health = 2, 1, 2
	index = "Core_2021~Rogue~Minion~2~1~2~~Patient Assassin~Poisonous~Stealth"
...
class PlagueScientist(Minion):
	...
	mana, attack, health = 3, 2, 3
	index = "Core_2021~Rogue~Minion~3~2~3~~Plague Scientist~Combo"
...
class SI7Agent(Minion):
	...
	mana, attack, health = 3, 3, 3
	index = "Core_2021~Rogue~Minion~3~3~3~~SI:7 Agent~Combo"
...
class AssassinsBlade(Weapon):
	...
	index = "Core_2021~Rogue~Weapon~4~2~5~Assassin's Blade"
	name_CN = "刺客之刃"
...
class Sprint(Spell):
	...
	requireTarget, mana = False, 6
	index = "Core_2021~Rogue~Spell~6~~Sprint"
...
class LightningBolt(Spell):
	...
	requireTarget, mana = True, 1
	index = "Core_2021~Shaman~Spell~1~Nature~Lightning Bolt~Overload"
...
class MenacingNimbus(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Shaman~Minion~2~2~2~Elemental~Menacing Nimbus~Battlecry"
	requireTarget, keyWord, description = False, "", "Battlecry: Add a random Elemental minion to your hand"
	name_CN = "凶恶的雨云"
	poolIdentifier = "Elementals"
	@classmethod
	def generatePool(cls, Game):
		return "Elementals", list(Game.MinionswithRace["Beast"].values())
...
class RockbiterWeapon(Spell):
	...
	requireTarget, mana = True, 2
	index = "Core_2021~Shaman~Spell~2~Nature~Rockbiter Weapon"
...
class Windfury(Spell):
	...
	requireTarget, mana = True, 2
	index = "Core_2021~Shaman~Spell~2~Nature~Windfury"
...
class LightningStorm(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Shaman~Spell~3~Nature~Lightning Storm~Overload"
...
class ManaTideTotem(Minion):
	...
	index = "Core_2021~Shaman~Minion~3~0~3~Totem~Mana Tide Totem"
...
class UnboundElemental(Minion):
	...
	mana, attack, health = 3, 2, 4
	index = "Core_2021~Shaman~Minion~3~2~4~Elemental~Unbound Elemental"
...
class DraeneiTotemcarver(Minion):
	...
	mana, attack, health = 4, 4, 4
	index = "Core_2021~Shaman~Minion~4~4~4~~Draenei Totemcarver~Battlecry"
...
class Hex(Spell):
	...
	requireTarget, mana = True, 4
	index = "Core_2021~Shaman~Spell~4~Nature~Hex"
...
class Frog(Minion):
	Class, race, name = "Shaman", "Beast", "Frog"
	mana, attack, health = 1, 0, 1
	index = "Core_2021~Shaman~Minion~1~0~1~Beast~Frog~Uncollectible"
...
class TidalSurge(Spell):
	...
	requireTarget, mana = True, 4
	index = "Core_2021~Shaman~Spell~4~Nature~Tidal Surge"
...
class Doomhammer(Weapon):
	...
	index = "Core_2021~Shaman~Weapon~5~2~8~Doomhammer~Windfury~Overload"
	name_CN = "毁灭之锤"
	def __init__(self, Game, ID):
		self.blank_init(Game, ID)
...
class EarthElemental(Minion):
	...
	index = "Core_2021~Shaman~Minion~5~7~8~Elemental~Earth Elemental~Taunt~Overload"
	requireTarget, keyWord, description = False, "Taunt", "Taunt. Overload: (2)"
	name_CN = "土元素"
	def __init__(self, Game, ID):
		self.blank_init(Game, ID)
...
class FireElemental(Minion):
	...
	mana, attack, health = 6, 6, 5
	index = "Core_2021~Shaman~Minion~6~6~5~Elemental~Fire Elemental~Battlecry"
...
class AlAkirtheWindlord(Minion):
	...
	index = "Core_2021~Shaman~Minion~8~3~6~Elemental~Al'Akir the Windlord~Taunt~Charge~Windfury~Divine Shield~Legendary"
...
class RitualofDoom(Spell):
	...
	requireTarget, mana = True, 0
	index = "Core_2021~Warlock~Spell~0~Shadow~Ritual of Doom"
...
class DemonicTyrant(Minion):
	...
	mana, attack, health = 5, 5, 5
	index = "Core_2021~Warlock~Minion~5~5~5~Demon~Demonic Tyrant~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "恶魔暴君"
...
class FlameImp(Minion):
	...
	mana, attack, health = 1, 3, 2
	index = "Core_2021~Warlock~Minion~1~3~2~Demon~Flame Imp~Battlecry"
...
class MortalCoil(Spell):
	...
	requireTarget, mana = True, 1
	index = "Core_2021~Warlock~Spell~1~Shadow~Mortal Coil"
...
class PossessedVillager(Minion):
	...
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Warlock~Minion~1~1~1~~Possessed Villager~Deathrattle"
...
class SummonaShadowBeast(Deathrattle_Minion):
	def effect(self, signal, ID, subject, target, number, comment, choice=0):
		self.entity.Game.summon(ShadowBeast(self.entity.Game, self.entity.ID), self.entity.pos+1, self.entity.ID)
		
	def text(self, CHN):
		return "亡语：召唤一个1/1的暗影兽" if CHN else "Deathrattle: Summon a 1/1 Shadow Beast"
		
class ShadowBeast(Minion):
	Class, race, name = "Warlock", "", "Shadow Beast"
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Warlock~Minion~1~1~1~~Shadow Beast~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "暗影兽"
...
class DrainSoul(Spell):
	...
	requireTarget, mana = True, 2
	index = "Core_2021~Warlock~Spell~2~Shadow~Drain Soul"
...
class TinyKnightofEvil(Minion):
	...
	mana, attack, health = 2, 3, 2
	index = "Core_2021~Warlock~Minion~2~3~2~Demon~Tiny Knight of Evil"
...
class VoidTerror(Minion):
	...
	mana, attack, health = 3, 3, 3
	index = "Core_2021~Warlock~Minion~3~3~3~Demon~Void Terror~Battlecry"
...
class FiendishCircle(Spell):
	...
	requireTarget, mana = False, 4
	index = "Core_2021~Warlock~Spell~4~Fel~Fiendish Circle"
	description = "Summon four 1/1 Imps"
	name_CN = "恶魔法阵"
	def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
		self.Game.summon([Imp(self.Game, self.ID) for i in range(3)], (-1, "totheRightEnd"), self.ID)
		return None
		
class Imp(Minion):
	Class, race, name = "Warlock", "Demon", "Imp"
	mana, attack, health = 1, 1, 1
	index = "Core_2021~Warlock~Minion~1~1~1~Demon~Imp~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "小鬼"
...
class Hellfire(Spell):
	...
	requireTarget, mana = False, 4
	index = "Core_2021~Warlock~Spell~4~Fire~Hellfire"
...
class LakkariFelhound(Minion):
	...
	index = "Core_2021~Warlock~Minion~4~3~8~Demon~Lakkari Felhound~Taunt~Battlecry"
...
class SiphonSoul(Spell):
	...
	index = "Core_2021~Warlock~Spell~5~Shadow~Siphon Soul"
...
class DreadInfernal(Minion):
	...
	index = "Core_2021~Warlock~Minion~6~6~6~Demon~Dread Infernal~Battlecry"
...
class EnslavedFelLord(Minion):
	Class, race, name = "Warlock", "Demon", "Enslaved FelLord"
	mana, attack, health = 7, 4, 10
	index = "Core_2021~Warlock~Minion~7~4~10~Demon~Enslaved FelLord~Taunt"
...
class Infernal(Minion):
	...
	mana, attack, health = 6, 6, 6
	index = "Core_2021~Warlock~Minion~6~6~6~Demon~Infernal~Uncollectible"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "地狱火"
...
class BloodFury(Weapon):
	...
	index = "Core_2021~Warlock~Weapon~3~3~8~Blood Fury~Uncollectible"
	name_CN = "血怒"
...
class LordJaraxxus(Hero):
	...
	index = "Core_2021~Warlock~Hero Card~9~Lord Jaraxxus~Battlecry~Legendary"
	name_CN = "加拉克苏斯大王"
...
class BloodsailDeckhand(Minion):
	...
	mana, attack, health = 1, 2, 1
	index = "Core_2021~Warrior~Minion~1~2~1~Pirate~Bloodsail Deckhand~Battlecry"
...
class Whirlwind(Spell):
	...
	requireTarget, mana = False, 1
	index = "Core_2021~Warrior~Spell~1~~Whirlwind"
...
class CruelTaskmaster(Minion):
	...
	mana, attack, health = 2, 2, 2
	index = "Core_2021~Warrior~Minion~2~2~2~~Cruel Taskmaster~Battlecry"
...
class Execute(Spell):
	...
	requireTarget, mana = True, 2
	index = "Core_2021~Warrior~Spell~2~~Execute"
...
class FieryWarAxe(Weapon):
	...
	index = "Core_2021~Warrior~Weapon~3~3~2~Fiery War Axe"
	name_CN = "炽炎战斧"
...
class WarsongCommander(Minion):
	...
	mana, attack, health = 3, 2, 3
	index = "Core_2021~Warrior~Minion~3~2~3~~Warsong Commander"
...
class Armorsmith(Minion):
	...
	index = "Core_2021~Warrior~Minion~2~1~4~~Armorsmith"
...
class FrothingBerserker(Minion):
	...
	mana, attack, health = 3, 2, 4
	index = "Core_2021~Warrior~Minion~3~2~4~~Frothing Berserker"
...
class WarCache(Spell):
	...
	requireTarget, mana = False, 3
	index = "Core_2021~Warrior~Spell~3~~War Cache"
...
class WarsongOutrider(Minion):
	...
	mana, attack, health = 4, 5, 4
	index = "Core_2021~Warrior~Minion~4~5~4~~Warsong Outrider"
	requireTarget, keyWord, description = False, "", ""
	name_CN = "战歌侦察骑兵"
...
class Brawl(Spell):
	...
	requireTarget, mana = False, 5
	index = "Core_2021~Warrior~Spell~5~Brawl"
...
class Shieldmaiden(Minion):
	...
	mana, attack, health = 3, 2, 4
	index = "Core_2021~Warrior~Minion~3~2~4~~Shieldmaiden~Battlecry"
...
class Gorehowl(Weapon):
	...
	index = "Core_2021~Warrior~Weapon~7~7~1~Gorehowl"
	name_CN = "血吼"
	def __init__(self, Game, ID):
		self.blank_init(Game, ID)
...
class GrommashHellscream(Minion):
	...
	index = "Core_2021~Warrior~Minion~8~4~9~~Grommash Hellscream~Charge~Legendary"
