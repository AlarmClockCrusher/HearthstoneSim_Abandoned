...
Default2 = [Khadgar, Khadgar, ConjurersCalling, ConjurersCalling, TourGuide, TourGuide, Renew, Renew,
            SorcerersApprentice, HighAbbessAlura, CommandingShout, PuzzleBoxofYoggSaron, SpiritJailer, SpiritJailer,
            SpiritJailer, FleshGiant, FleshGiant, ShardshatterMystic
            ]