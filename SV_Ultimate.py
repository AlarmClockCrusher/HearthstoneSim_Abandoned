...
SV_Ultimate_Indices = {
    "SV_Ultimate~Havencraft~Minion~2~1~2~~Holy Cavalier~Taunt~Legendary~Uncollectible": HolyCavalier,
    "SV_Ultimate~Havencraft~Spell~3~Wilbert, Grand Knight~Accelerate~Legendary~Uncollectible": WilbertGrandKnight_Accelerate,
    "SV_Ultimate~Havencraft~Minion~6~4~6~~Wilbert, Grand Knight~Battlecry~Deathrattle~Accelerate~Legendary": WilbertGrandKnight,
    "SV_Ultimate~Havencraft~Minion~6~3~3~~Goddess of the West Wind~Battlecry~Legendary": GoddessoftheWestWind
}
from CardTypes import *
from Triggers_Auras import *
from SV_Basic import *
