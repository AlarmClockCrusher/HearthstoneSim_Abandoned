...
class AnveltJudgmentsCannon_Crystallize(Amulet):
    ...
    mana = 1
    index = "SV_Rivayle~Havencraft~Amulet~1~~Anvelt, Judgment's Cannon~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible"
...
SV_Rivayle_Indices = {
    ...
    "SV_Rivayle~Neutral~Minion~1~1~1~~Rivaylian Bandit~Enhance~Battlecry": RivaylianBandit,
    "SV_Rivayle~Neutral~Minion~2~2~2~~Quixotic Adventurer~Battlecry": QuixoticAdventurer,
    "SV_Rivayle~Neutral~Minion~2~2~2~~Wandering Chef": WanderingChef,
    "SV_Rivayle~Neutral~Minion~2~2~2~~Ramiel~Taunt~Legendary": Ramiel,
    "SV_Rivayle~Havencraft~Spell~1~Set~Accelerate~Uncollectible": Set_Accelerate,
    "SV_Rivayle~Havencraft~Minion~7~2~8~~Set~Bane~Taunt~Accelerate": Set,
    "SV_Rivayle~Havencraft~Amulet~1~~Anvelt, Judgment's Cannon~Countdown~Crystallize~Deathrattle~Legendary~Uncollectible": AnveltJudgmentsCannon_Crystallize,
    "SV_Rivayle~Havencraft~Minion~7~5~6~~Anvelt, Judgment's Cannon~Taunt~Crystallize~Legendary": AnveltJudgmentsCannon,
    "SV_Rivayle~Neutral~Minion~4~5~5~~Goblin King~Taunt~Uncollectible": GoblinKing,
    "SV_Rivayle~Neutral~Minion~3~3~3~~Goblin Queen~Battlecry": GoblinQueen
}
from CardTypes import *
from Triggers_Auras import *
from SV_Basic import *
