...
MinionsofCost = {
			...
			Wolpertinger, LabPartner, WandThief, FrazzledFreshman, SpiritJailer, SafetyInspector, MysteryWinner, PrizePlunderer, 			],
			...
			TransferStudent_Stranglethorn, CostumedEntertainer, HorrendousGrowth, ParadeLeader, PrizeVendor, RockRager, Showstopper, WrigglingHorror, RedeemedPariah, DancingCobra, 
			...
			OccultConjurer, BalloonMerchant, TheNamelessOne, FireBreather, SwordEater, 			],
			...
			PitCommander, YsielWindsinger, AncientVoidHound, Rattlegore, CarnivalClown, FizzyElemental, BloodofGhuun, 			],
...
RNGPools = {
		'Legendary Minions': [BloodmageThalnos, LorewalkerCho, MillhouseManastorm, NatPagle, Brightwing, KingMukla, TinkmasterOverspark, CaptainGreenskin, HarrisonJones, CairneBloodhoof, 
				...
				GrandEmpressShekzara, GrandTotemEysor, InaraStormcrash, Tickatus, ETCGodofMetal, RingmasterWhatley, ],
		...
		'Legendary Minions as Forestcraft to Summon': [BloodmageThalnos, LorewalkerCho, MillhouseManastorm, NatPagle, Brightwing, KingMukla, TinkmasterOverspark, CaptainGreenskin, HarrisonJones, CairneBloodhoof, 
				Hogger, Xavius, TheBeast, TheBlackKnight, BaronGeddon, HighInquisitorWhitemane, Gruul, Alexstrasza, Malygos, Nozdormu, 
				Onyxia, Ysera, Deathwing, TeronGorefiend, MaievShadowsong, Alar, KaelthasSunstrider, LorekeeperPolkelt, HeadmasterKelThuzad, Vectus, 
				KeymasterAlabaster, SilasDarkmoon, CThuntheShattered, NZothGodoftheDeep, YoggSaronMasterofFate, YShaarjtheDefiler, ],
		...
		'2-Cost Minions to Summon': [AcidicSwampOoze, BloodfenRaptor, BluegillWarrior, FrostwolfGrunt, KoboldGeomancer, MurlocTidehunter, NoviceEngineer, RiverCrocolisk, SightlessWatcher, Felstalker, 
				...
				CultNeophyte, ManafeederPanthara, SneakyDelinquent, VoraciousReader, Wandmaker, ArgentBraggart, DiligentNotetaker, TrickTotem, BonewebEgg, TransferStudent_Stranglethorn, 
		...
		'1-Cost Minions to Summon': [ElvenArcher, GoldshireFootman, GrimscaleOracle, MurlocRaider, StonetuskBoar, VoodooDoctor, ShadowhoofSlayer, TimberWolf, PsychicConjurer, Voidwalker, 
				...
				LabPartner, WandThief, FrazzledFreshman, SpiritJailer, SafetyInspector, MysteryWinner, PrizePlunderer, ],
		...
		'4-Cost Minions to Summon': [ChillwindYeti, DragonlingMechanic, GnomishInventor, OasisSnapjaw, OgreMagi, SenjinShieldmasta, StormwindKnight, Houndmaster, WaterElemental, Plaguebringer, 
				...
				TheNamelessOne, FireBreather, SwordEater, ],
		'5-Cost Minions to Summon': [BootyBayBodyguard, DarkscaleHealer, FrostwolfWarlord, GurubashiBerserker, Nightblade, StormpikeCommando, GlaiveboundAdept, StarvingBuzzard, TundraRhino, Abomination, 
				...
				Greybough, TramplingRhino, FireworkElemental, CarouselGryphon, LothraxiontheRedeemed, FortuneTeller, InaraStormcrash, RingmasterWhatley, TentTrasher, ],
		...
		'9-Cost Minions to Summon': [Alexstrasza, Malygos, Nozdormu, Onyxia, Ysera, Cenarius, KingKrush, LordJaraxxus, Nethrandamus, PitCommander, 
				YsielWindsinger, AncientVoidHound, Rattlegore, CarnivalClown, FizzyElemental, BloodofGhuun, ],
		...
		'2-Cost Spells': [ChaosStrike, FeastofSouls, ImmolationAura, SpectralSight, SoulShear, MarkoftheWild, PoweroftheWild, Wrath, Ironbark, GuesstheWeight, 
				...
				CommandingShout, Rampage, Slam, CorsairCache, InFormation, Minefield, ],
		'3-Cost Spells': [CoordinatedStrike, SoulCleave, BladeDance, EyeBeam, Acrobatics, RelentlessPursuit, HealingTouch, SavageRoar, WildGrowth, MarkofNature, 
				...
				FreeAdmission, ShieldBlock, Bladestorm, Coerce, FeatofStrength, ],
		...
		'4-Cost Spells': [SoulSplit, Glide, Swipe, Bite, SouloftheForest, Germination, Overgrowth, MultiShot, ScrapShot, Fireball, 
				...
				Hellfire, Shadowflame, TheDarkPortal, CascadingDisaster, MortalStrike, ],
		...
		'Deathrattle Minions as Forestcraft': [LeperGnome, BloodmageThalnos, LootHoarder, HarvestGolem, Abomination, CairneBloodhoof, TheBeast, RustswornInitiate, TeronGorefiend, DisguisedWanderer, 
		...
		'Deathrattle Minions as Swordcraft': [LeperGnome, BloodmageThalnos, LootHoarder, HarvestGolem, Abomination, CairneBloodhoof, TheBeast, RustswornInitiate, TeronGorefiend, DisguisedWanderer, 
				Alar, DragonmawSkyStalker, ScrapyardColossus, SneakyDelinquent, EducatedElekk, FishyFlyer, SmugSenior, PlaguedProtodrake, Showstopper, ClawMachine, 
				],
		'Deathrattle Minions as Runecraft': [LeperGnome, BloodmageThalnos, LootHoarder, HarvestGolem, Abomination, CairneBloodhoof, TheBeast, RustswornInitiate, TeronGorefiend, DisguisedWanderer, 
				Alar, DragonmawSkyStalker, ScrapyardColossus, SneakyDelinquent, EducatedElekk, FishyFlyer, SmugSenior, PlaguedProtodrake, Showstopper, ClawMachine, 
				],
		...
		'Deathrattle Minions as Shadowcraft': [LeperGnome, BloodmageThalnos, LootHoarder, HarvestGolem, Abomination, CairneBloodhoof, TheBeast, RustswornInitiate, TeronGorefiend, DisguisedWanderer, 
				Alar, DragonmawSkyStalker, ScrapyardColossus, SneakyDelinquent, EducatedElekk, FishyFlyer, SmugSenior, PlaguedProtodrake, Showstopper, ClawMachine, 
				],
		'Deathrattle Minions as Bloodcraft': [LeperGnome, BloodmageThalnos, LootHoarder, HarvestGolem, Abomination, CairneBloodhoof, TheBeast, RustswornInitiate, TeronGorefiend, DisguisedWanderer, 
				Alar, DragonmawSkyStalker, ScrapyardColossus, SneakyDelinquent, EducatedElekk, FishyFlyer, SmugSenior, PlaguedProtodrake, Showstopper, ClawMachine, 
				],
		'Deathrattle Minions as Havencraft': [LeperGnome, BloodmageThalnos, LootHoarder, HarvestGolem, Abomination, CairneBloodhoof, TheBeast, RustswornInitiate, TeronGorefiend, DisguisedWanderer, 
				Alar, DragonmawSkyStalker, ScrapyardColossus, SneakyDelinquent, EducatedElekk, FishyFlyer, SmugSenior, PlaguedProtodrake, Showstopper, ClawMachine, 
				],
		'Deathrattle Minions as Portalcraft': [LeperGnome, BloodmageThalnos, LootHoarder, HarvestGolem, Abomination, CairneBloodhoof, TheBeast, RustswornInitiate, TeronGorefiend, DisguisedWanderer, 
				Alar, DragonmawSkyStalker, ScrapyardColossus, SneakyDelinquent, EducatedElekk, FishyFlyer, SmugSenior, PlaguedProtodrake, Showstopper, ClawMachine, 
				],
		...
		'Spells of <=3 Cost': [ChaosStrike, CoordinatedStrike, SoulCleave, Blur, TwinSlice, ConsumeMagic, ManaBurn, BladeDance, FeastofSouls, EyeBeam, 
				...
				StageDive, Minefield, FeatofStrength, ],
		...
		'Rush Minions as Swordcraft': [ImprisonedVilefiend, RuststeedRaider, AnimatedBroomstick, FishyFlyer, FleethoofPearltusk, ClawMachine, DarkmoonRabbit, ],
		...
		'Rush Minions as Bloodcraft': [ImprisonedVilefiend, RuststeedRaider, AnimatedBroomstick, FishyFlyer, FleethoofPearltusk, ClawMachine, DarkmoonRabbit, ],
		...
		'Rush Minions as Portalcraft': [ImprisonedVilefiend, RuststeedRaider, AnimatedBroomstick, FishyFlyer, FleethoofPearltusk, ClawMachine, DarkmoonRabbit, ],
		...
		'4-Cost Minions': [ChillwindYeti, DragonlingMechanic, GnomishInventor, OasisSnapjaw, OgreMagi, SenjinShieldmasta, StormwindKnight, Houndmaster, WaterElemental, Plaguebringer, 
				...
				BalloonMerchant, TheNamelessOne, FireBreather, SwordEater, ],
