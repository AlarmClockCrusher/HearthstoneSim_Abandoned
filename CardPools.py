...
MinionsofCost = {
			...
			TransferStudent_Ogrimmar, CostumedEntertainer, HorrendousGrowth, ParadeLeader, PrizeVendor, RockRager, Showstopper, WrigglingHorror, RedeemedPariah, DancingCobra, 
...
RNGPools = {
		...
		'2-Cost Minions to Summon': [AcidicSwampOoze, BloodfenRaptor, BluegillWarrior, FrostwolfGrunt, KoboldGeomancer, MurlocTidehunter, NoviceEngineer, RiverCrocolisk, SightlessWatcher, Felstalker, 
				...
				CultNeophyte, ManafeederPanthara, SneakyDelinquent, VoraciousReader, Wandmaker, ArgentBraggart, DiligentNotetaker, TrickTotem, BonewebEgg, TransferStudent_Ogrimmar, 
		...
		'Minions to Summon': [ElvenArcher, GoldshireFootman, GrimscaleOracle, MurlocRaider, StonetuskBoar, VoodooDoctor, ShadowhoofSlayer, TimberWolf, PsychicConjurer, Voidwalker, 
				...
				SneakyDelinquent, VoraciousReader, Wandmaker, ArgentBraggart, DiligentNotetaker, TrickTotem, BonewebEgg, TransferStudent_Ogrimmar, CostumedEntertainer, HorrendousGrowth, 
