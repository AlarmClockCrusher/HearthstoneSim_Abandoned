...
Default2 = [RaiseDead, MindrenderIllucia, PowerWordFeast, SecretPassage, SelfSharpeningSword, MindrenderIllucia, SelfSharpeningSword, DoctorKrastinov,
			GuardianAnimals,GuardianAnimals,TeachersPet,TeachersPet,TeachersPet,TeachersPet,TeachersPet,TeachersPet,
