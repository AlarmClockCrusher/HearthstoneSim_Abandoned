...
class WellofDestiny(Amulet):
    ...
    mana = 2
    index = "SV_Basic~Neutral~Amulet~2~~Well of Destiny"
...
class Deathrattle_WaterFairy(Deathrattle_Minion):
    def effect(self, signal, ID, subject, target, number, comment, choice=0):
        self.entity.Game.Hand_Deck.addCardtoHand(Fairy, self.entity.ID, byType=True, creator=type(self.entity))
...
class FairyWhisperer(SVMinion):
    ...
    def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
        self.Game.Hand_Deck.addCardtoHand([Fairy for i in range(2)], self.ID, byType=True, creator=type(self))
        return None
...
class Trig_Spellboost(TrigHand):
    def __init__(self, entity):
        super().__init__(entity, ["Spellboost"])
...
class Conflagration(SVSpell):
    Class, school, name = "Dragoncraft", "", "Conflagration"
...
class DemonicStorm(SVSpell):
    Class, school, name = "Bloodcraft", "", "Demonic Storm"
...
class SummonPegasus(Amulet):
    ...
    mana = 1
    index = "SV_Basic~Havencraft~Amulet~1~~Summon Pegasus~Countdown~Deathrattle"
...
class PinionPrayer(Amulet):
    ...
    mana = 1
    index = "SV_Basic~Havencraft~Amulet~1~~Pinion Prayer~Countdown~Deathrattle"
...
class BeastlyVow(Amulet):
    ...
    mana = 2
    index = "SV_Basic~Havencraft~Amulet~2~~Beastly Vow~Countdown~Deathrattle"
...
class FeatherwyrmsDescent(Amulet):
    ...
    mana = 3
    index = "SV_Basic~Havencraft~Amulet~3~~Featherwyrm's Descent~Countdown~Deathrattle"
...
class DualFlames(Amulet):
    Class, race, name = "Havencraft", "", "Beastly Vow"
    mana = 5
    index = "SV_Basic~Havencraft~Amulet~5~~Beastly Vow~Countdown~Deathrattle"
...
class Puppeteer(SVMinion):
    ...
    def inHandEvolving(self, target=None):
        self.Game.Hand_Deck.addCardtoHand(Puppet, self.ID, byType=True, creator=type(self))
        curGame = self.Game
...
class MagisteelLion(SVMinion):
    ...
    def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
        self.Game.Hand_Deck.shuffleintoDeck([AnalyzingArtifact(self.Game, self.ID) for i in range(2)], creator=self)
        return None
...
class Deathrattle_AutomatonKnight(Deathrattle_Minion):
    def effect(self, signal, ID, subject, target, number, comment, choice=0):
        self.entity.Game.Hand_Deck.addCardtoHand(Puppet, self.entity.ID, byType=True, creator=type(self.entity))
...
class IronforgedFighter(SVMinion):
    ...
    def whenEffective(self, target=None, comment="", choice=0, posinHand=-2):
        self.Game.Hand_Deck.shuffleintoDeck([RadiantArtifact(self.Game, self.ID) for i in range(2)], creator=self)
        return None
...
class PuppeteersStrings(SVSpell):
    Class, school, name = "Portalcraft", "", "Puppeteer's Strings"
...
SV_Basic_Indices = {
    ...
    "SV_Basic~Neutral~Minion~1~1~2~~Goblin": Goblin,
    "SV_Basic~Neutral~Minion~2~2~2~~Fighter": Fighter,
    "SV_Basic~Neutral~Amulet~2~~Well of Destiny": WellofDestiny,
    "SV_Basic~Neutral~Minion~3~3~2~~Mercenary Drifter": MercenaryDrifter,
    "SV_Basic~Neutral~Minion~3~2~1~~Harnessed Flame": HarnessedFlame,
    "SV_Basic~Neutral~Minion~3~2~1~~Harnessed Glass": HarnessedGlass,
    "SV_Basic~Neutral~Minion~7~7~7~~Flame and Glass~Charge~Uncollectible": FlameandGlass,
    "SV_Basic~Neutral~Minion~4~3~4~~Goliath": Goliath,
    "SV_Basic~Neutral~Minion~5~2~6~~Angelic Sword Maiden~Taunt": AngelicSwordMaiden,

    "SV_Basic~Forestcraft~Minion~1~1~1~~Fairy~Uncollectible": Fairy,
    "SV_Basic~Forestcraft~Minion~0~1~1~~Fairy Wisp~Battlecry~Uncollectible": FairyWisp,
    "SV_Basic~Forestcraft~Minion~1~1~1~~Water Fairy~Deathrattle": WaterFairy,
    "SV_Basic~Forestcraft~Minion~2~1~1~~Fairy Whisperer~Battlecry": FairyWhisperer,
    "SV_Basic~Forestcraft~Minion~2~1~3~~Elf Guard~Battlecry": ElfGuard,
    "SV_Basic~Forestcraft~Minion~2~2~1~~Elf Metallurgist~Battlecry": ElfMetallurgist,
    "SV_Basic~Forestcraft~Spell~2~Sylvan Justice": SylvanJustice,
    "SV_Basic~Forestcraft~Minion~3~2~3~~Dark Elf Faure": DarkElfFaure,
    "SV_Basic~Forestcraft~Minion~4~3~4~~Okami": Okami,
    "SV_Basic~Forestcraft~Minion~4~4~3~~Rose Gardener": RoseGardener,
    "SV_Basic~Forestcraft~Minion~5~4~4~~Treant~Battlecry": Treant,
    "SV_Basic~Forestcraft~Minion~6~4~5~~Elf Tracker~Battlecry": ElfTracker,
    "SV_Basic~Forestcraft~Minion~6~5~5~~Magna Botanist~Battlecry": MagnaBotanist,
    ...
    "SV_Basic~Runecraft~Minion~2~2~2~~Clay Golem~Uncollectible": ClayGolem,
    "SV_Basic~Runecraft~Minion~1~1~1~~Snowman~Uncollectible": Snowman,
    "SV_Basic~Runecraft~Amulet~1~Earth Sigil~Earth Essence~Uncollectible": EarthEssence,
    "SV_Basic~Runecraft~Minion~4~3~3~~Guardian Golem~Taunt~Uncollectible": GuardianGolem,
    "SV_Basic~Runecraft~Minion~1~0~2~~Scrap Golem~Taunt~Uncollectible": ScrapGolem,
    "SV_Basic~Runecraft~Spell~2~Conjure Guardian~Uncollectible": ConjureGuardian,
    "SV_Basic~Runecraft~Spell~1~Insight": Insight,
    "SV_Basic~Runecraft~Minion~2~2~2~~Sammy, Wizard's Apprentice~Battlecry": SammyWizardsApprentice,
    ...
    "SV_Basic~Runecraft~Minion~4~3~4~~Demonflame Mage": DemonflameMage,
    "SV_Basic~Runecraft~Spell~4~Conjure Twosome": ConjureTwosome,
    "SV_Basic~Runecraft~Minion~5~3~3~~Lightning Shooter~Battlecry~Spellboost": LightningShooter,
    "SV_Basic~Runecraft~Spell~8~Fiery Embrace~Spellboost": FieryEmbrace,
    "SV_Basic~Runecraft~Minion~10~7~7~~Flame Destroyer~Spellboost": FlameDestroyer,

    "SV_Basic~Dragoncraft~Minion~2~2~2~~Megalorca~Uncollectible": Megalorca,
    "SV_Basic~Dragoncraft~Spell~1~Blazing Breath": BlazingBreath,
    "SV_Basic~Dragoncraft~Minion~2~2~2~~Dragonrider": Dragonrider,
    "SV_Basic~Dragoncraft~Spell~2~Dragon Oracle": DragonOracle,
    "SV_Basic~Dragoncraft~Minion~3~2~3~~Firstborn Dragon": FirstbornDragon,
    "SV_Basic~Dragoncraft~Minion~4~4~4~~Death Dragon": DeathDragon,
    "SV_Basic~Dragoncraft~Minion~4~3~4~~Dragon Warrior": DragonWarrior,
    "SV_Basic~Dragoncraft~Spell~4~Serpent Wrath": SerpentWrath,
    "SV_Basic~Dragoncraft~Minion~5~4~5~~Disaster Dragon": DisasterDragon,
    "SV_Basic~Dragoncraft~Minion~6~5~6~~Dragonguard": Dragonguard,
    "SV_Basic~Dragoncraft~Minion~7~4~4~~Dread Dragon~Battlecry": DreadDragon,
    "SV_Basic~Dragoncraft~Spell~7~Conflagration": Conflagration,

    "SV_Basic~Shadowcraft~Minion~1~1~1~~Skeleton~Uncollectible": Skeleton,
    "SV_Basic~Shadowcraft~Minion~2~2~2~~Zombie~Uncollectible": Zombie,
    "SV_Basic~Shadowcraft~Minion~4~4~4~~Lich~Uncollectible": Lich,
    "SV_Basic~Shadowcraft~Minion~1~1~1~~Ghost~Charge~Uncollectible": Ghost,
    "SV_Basic~Shadowcraft~Minion~2~2~2~~Spartoi Sergeant~Battlecry": SpartoiSergeant,
    "SV_Basic~Shadowcraft~Minion~2~2~1~~Spectre~Bane": Spectre,
    "SV_Basic~Shadowcraft~Spell~2~Undying Resentment~Necromancy": UndyingResentment,
    "SV_Basic~Shadowcraft~Minion~3~2~3~~Apprentice Necromancer~Battlecry~Necromancy": ApprenticeNecromancer,
    "SV_Basic~Shadowcraft~Minion~4~4~3~~Elder Spartoi Soldier~Battlecry": ElderSpartoiSoldier,
    "SV_Basic~Shadowcraft~Minion~4~4~3~~Playful Necromancer": PlayfulNecromancer,
    "SV_Basic~Shadowcraft~Minion~4~1~1~~Hell's Unleasher~Deathrattle": HellsUnleasher,
    "SV_Basic~Shadowcraft~Spell~4~Call of the Void": CallofVoid,
    "SV_Basic~Shadowcraft~Minion~5~3~3~~Gravewaker~Deathrattle": Gravewaker,
    "SV_Basic~Shadowcraft~Minion~6~5~5~~Ghostly Rider~Deathrattle": GhostlyRider,
    "SV_Basic~Shadowcraft~Minion~7~4~4~~Undead King~Deathrattle": UndeadKing,
    "SV_Basic~Shadowcraft~Minion~1~1~1~~Fores tBat~Uncollectible": ForestBat,

    "SV_Basic~Bloodcraft~Minion~2~2~2~~Nightmare~Battlecry": Nightmare,
    "SV_Basic~Bloodcraft~Minion~2~1~3~~Sweetfang Vampire~Drain": SweetfangVampire,
    "SV_Basic~Bloodcraft~Spell~2~Blood Pact": BloodPact,
    "SV_Basic~Bloodcraft~Spell~2~Razory Claw": RazoryClaw,
    "SV_Basic~Bloodcraft~Minion~3~3~3~~Crazed Executioner~Battlecry": CrazedExecutioner,
    "SV_Basic~Bloodcraft~Minion~4~4~3~~Dark General~Battlecry": DarkGeneral,
    "SV_Basic~Bloodcraft~Minion~4~3~4~~Wardrobe Raider": WardrobeRaider,
    "SV_Basic~Bloodcraft~Spell~4~Crimson Purge": CrimsonPurge,
    "SV_Basic~Bloodcraft~Minion~6~3~6~~Imp Lancer~Charge": ImpLancer,
    "SV_Basic~Bloodcraft~Spell~6~Demonic Storm": DemonicStorm,
    "SV_Basic~Bloodcraft~Minion~7~5~6~~Abyss Beast~Battlecry": AbyssBeast,

    "SV_Basic~Havencraft~Minion~5~5~3~~Pegasus~Uncollectible": Pegasus,
    "SV_Basic~Havencraft~Minion~3~2~1~~Holy Falcon~Charge~Uncollectible": HolyFalcon,
    "SV_Basic~Havencraft~Minion~4~4~4~~Holyflame Tiger~Uncollectible": HolyflameTiger,
    "SV_Basic~Havencraft~Minion~6~6~6~~Holywing Dragon~Uncollectible": HolywingDragon,
    "SV_Basic~Havencraft~Amulet~1~~Summon Pegasus~Countdown~Deathrattle": SummonPegasus,
    "SV_Basic~Havencraft~Amulet~1~~Pinion Prayer~Countdown~Deathrattle": PinionPrayer,
    "SV_Basic~Havencraft~Minion~2~1~3~~Snake Priestess~Taunt": SnakePriestess,
    ...
    "SV_Basic~Havencraft~Amulet~2~~Beastly Vow~Countdown~Deathrattle": BeastlyVow,
    "SV_Basic~Havencraft~Amulet~3~~Featherwyrm's Descent~Countdown~Deathrattle": FeatherwyrmsDescent,
    "SV_Basic~Havencraft~Minion~4~3~4~~Priest of the Cudgel": PriestoftheCudgel,
    "SV_Basic~Havencraft~Minion~5~3~4~~Greater Priestess~Battlecry": GreaterPriestess,
    "SV_Basic~Havencraft~Spell~5~Acolyte's Light": AcolytesLight,
    "SV_Basic~Havencraft~Amulet~5~~Beastly Vow~Countdown~Deathrattle": BeastlyVow,
    "SV_Basic~Havencraft~Minion~7~5~5~~Curate~Battlecry": Curate,
    ...
    "SV_Basic~Portalcraft~Minion~0~1~1~~Puppet~Rush~Uncollectible": Puppet,
    ...
    "SV_Basic~Portalcraft~Minion~2~2~2~~Puppeteer": Puppeteer,
    "SV_Basic~Portalcraft~Minion~2~2~2~~Mechanized Servant~Battlecry": MechanizedServant,
    "SV_Basic~Portalcraft~Minion~2~2~2~~Magisteel Lion~Battlecry": MagisteelLion,
    "SV_Basic~Portalcraft~Minion~2~2~2~~Magisteel Puppet": MagisteelPuppet,
    "SV_Basic~Portalcraft~Spell~2~Dimension Cut": DimensionCut,
    "SV_Basic~Portalcraft~Minion~3~2~1~~Toy Soldier": ToySoldier,
    "SV_Basic~Portalcraft~Minion~3~3~2~~Automaton Knight~Deathrattle": AutomatonKnight,
    "SV_Basic~Portalcraft~Minion~4~4~3~~Ironforged Fighter~Battlecry": IronforgedFighter,
    "SV_Basic~Portalcraft~Minion~4~3~4~~Roan Winged Nexx": RoanWingedNexx,
    "SV_Basic~Portalcraft~Spell~4~Puppeteer's Strings": PuppeteersStrings,
    "SV_Basic~Portalcraft~Minion~6~5~6~~Black Iron Soldier~Battlecry": BlackIronSoldier,
}
from SV_CardTypes import *
from Triggers_Auras import *
